...
(() => {
  ...
  // src/livecodes/languages/fennel/lang-fennel-compiler.ts
  var PACKAGE_PATH_URL = vendorsBaseUrl + "fennel/?.lua";
  self.createFennelCompiler = () => {
    const fnl = `
