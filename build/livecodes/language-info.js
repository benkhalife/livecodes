...
var language_info_default = `<section data-lang="art-template">
...
<section data-lang="csharp-wasm">
  <h3 data-i18n="language-info:csharpWasm.name">C# (Wasm)</h3>
  <div data-i18n="language-info:csharpWasm.desc" data-i18n-prop="innerHTML">
  ...
  <ul data-i18n="language-info:csharpWasm.link" data-i18n-prop="innerHTML">
    <li>
      <a href="https://learn.microsoft.com/en-us/dotnet/csharp/" target="_blank" rel="noopener"
        >C# language documentation</a
      >
    </li>
    <li>
      <a href="https://learnxinyminutes.com/docs/csharp/" target="_blank" rel="noopener"
        >Learn X in Y minutes, where X=C#</a
      >
    </li>
    <li>
      <a href="{{DOCS_BASE_URL}}languages/csharp-wasm" target="_blank" rel="noopener"
        >LiveCodes Documentation</a
      >
    </li>
    <li>
      <a href="?template=csharp-wasm" class="button" target="_parent" data-template="csharp-wasm"
        >Load starter template</a
      >
    </li>
  </ul>
...
<section data-lang="diagrams">
  ...
  <ul data-i18n="language-info:diagrams.link" data-i18n-prop="innerHTML">
    <li>
      <a href="?template=diagrams" class="button" target="_parent" data-template="diagrams"
        >Load starter template</a
      >
    </li>
    <li>
...
<section data-lang="go">
  ...
  <ul data-i18n="language-info:go.link" data-i18n-prop="innerHTML">
    ...
    <li>
      <a href="{{DOCS_BASE_URL}}languages/go" target="_blank" rel="noopener"
        >LiveCodes Documentations</a
      >
    </li>
    <li>
...
<section data-lang="go-wasm">
  <h3 data-i18n="language-info:goWasm.name">Go (Wasm)</h3>
  <div data-i18n="language-info:goWasm.desc">
    Go interpreter running on WebAssembly, using Yaegi
  </div>
  <ul data-i18n="language-info:goWasm.link" data-i18n-prop="innerHTML">
    <li><a href="https://golang.org/" target="_blank" rel="noopener">Go official website</a></li>
    <li><a href="https://yaegi.org/" target="_blank" rel="noopener">Yaegi</a></li>
    <li>
      <a href="https://learnxinyminutes.com/docs/go/" target="_blank" rel="noopener"
        >Learn X in Y minutes, where X=Go</a
      >
    ...
    <li>
      <a href="{{DOCS_BASE_URL}}languages/go-wasm" target="_blank" rel="noopener"
        >LiveCodes Documentations</a
      >
    </li>
    <li>
      <a href="?template=go-wasm" class="button" target="_parent" data-template="go-wasm"
        >Load starter template</a
      >
    </li>
  </ul>
...
<section data-lang="java">
  <h3 data-i18n="language-info:java.name">Java</h3>
  <div data-i18n="language-info:java.desc" data-i18n-prop="innerHTML">
    JVM running in the browser using DoppioJVM.
  </div>
  <ul data-i18n="language-info:java.link" data-i18n-prop="innerHTML">
    <li>
      <a href="https://www.java.com/" target="_blank" rel="noopener">Java official website</a>
    </li>
    <li>
      <a href="https://github.com/plasma-umass/doppio" target="_blank" rel="noopener">DoppioJVM</a>
    </li>
    <li>
      <a href="https://learnxinyminutes.com/docs/java/" target="_blank" rel="noopener"
        >Learn X in Y minutes, where X=java</a
      >
    </li>
    <li>
      <a href="{{DOCS_BASE_URL}}languages/java" target="_blank" rel="noopener"
        >LiveCodes Documentation</a
      >
    </li>
    <li>
      <a href="?template=java" class="button" target="_parent" data-template="java"
        >Load starter template</a
      >
    </li>
  </ul>
...
<section data-lang="react-tsx">
  <h3 data-i18n="language-info:reactTsx.name">React Compiler (with TypeScript)</h3>
  <div data-i18n="language-info:reactTsx.desc">
    React Compiler is a build-time only tool that automatically optimizes React apps.
  </div>
  <ul data-i18n="language-info:reactTsx.link" data-i18n-prop="innerHTML">
    <li>
      <a href="https://react.dev/" target="_blank" rel="noopener">React official website</a>
    </li>
    <li>
      <a href="https://react.dev/learn/react-compiler" target="_blank" rel="noopener"
        >React Compiler</a
      >
    </li>
    <li>
    ...
    <li>
      <a href="{{DOCS_BASE_URL}}languages/react-tsx" target="_blank" rel="noopener"
        >LiveCodes Documentations</a
      >
    </li>
    <li>
      <a href="?template=react" class="button" target="_parent" data-template="react-tsx"
        >Load starter template (JSX)</a
      >
    </li>
  </ul>
</section>
<section data-lang="react">
  <h3 data-i18n="language-info:react.name">React Compiler</h3>
  <div data-i18n="language-info:react.desc">
    React Compiler is a build-time only tool that automatically optimizes React apps.
  </div>
  <ul data-i18n="language-info:react.link" data-i18n-prop="innerHTML">
    <li>
      <a href="https://react.dev/" target="_blank" rel="noopener">React official website</a>
    </li>
    <li>
    ...
    <li>
      <a href="{{DOCS_BASE_URL}}languages/react" target="_blank" rel="noopener"
        >LiveCodes Documentations</a
      >
    </li>
    <li>
