...
var evaluateCssCalc = (expression) => {
...
var stringUnionToArray = () => (...elements) => elements;
...
// src/livecodes/html/app-menu-project.html?raw
var app_menu_project_default = '<ul id="app-menu-project" class="dropdown-menu">\n  <li>\n    <a href="#" id="new-link">\n      <span data-i18n="menu.new">New \u2026 </span>\n      <span><kbd>Ctrl</kbd><kbd>Alt</kbd><kbd>N</kbd></span>\n    </a>\n  </li>\n  <li>\n    <a href="#" id="open-link">\n      <span data-i18n="menu.open">Open \u2026</span>\n      <span><kbd>Ctrl</kbd><kbd>O</kbd></span>\n    </a>\n  </li>\n  <li role="separator"></li>\n  <li>\n    <a href="#" id="save-link">\n      <span data-i18n="menu.save">Save</span>\n      <span><kbd>Ctrl</kbd><kbd>S</kbd></span>\n    </a>\n  </li>\n  <li>\n    <i class="arrow submenu-chevron"></i>\n    <a href="#" id="save-as">\n      <span data-i18n="menu.saveAs.heading">Save as \u2026</span>\n    </a>\n    <ul class="dropdown-menu submenu" id="save-as-menu">\n      <li>\n        <a href="#" id="fork-link">\n          <span data-i18n="menu.saveAs.fork">Fork (New Project)</span>\n          <span><kbd>Ctrl</kbd><kbd>\u21E7</kbd><kbd>S</kbd></span>\n        </a>\n      </li>\n      <li>\n        <a href="#" id="template-link" data-i18n="menu.saveAs.template">Template</a>\n      </li>\n    </ul>\n  </li>\n  <li role="separator"></li>\n  <li>\n    <a href="#" id="import-link">\n      <span data-i18n="menu.import">Import \u2026</span>\n      <span><kbd>Ctrl</kbd><kbd>Alt</kbd><kbd>I</kbd></span>\n    </a>\n  </li>\n  <li>\n    <i class="arrow submenu-chevron"></i>\n    <a href="#" id="export" data-i18n="menu.export.heading">Export</a>\n    <ul class="dropdown-menu submenu" id="export-menu">\n      <li>\n        <a href="#" id="export-json" data-i18n="menu.export.json">Export Project (JSON)</a>\n      </li>\n      <li>\n        <a href="#" id="export-src" data-i18n="menu.export.src">Export Source (ZIP)</a>\n      </li>\n      <li>\n        <a href="#" id="export-result" data-i18n="menu.export.result">Export Result (HTML)</a>\n      </li>\n      <li>\n        <a href="#" id="export-githubGist" data-i18n="menu.export.gist">Export to GitHub Gist</a>\n      </li>\n      <li>\n        <a href="#" id="export-codepen" data-i18n="menu.export.codepen">Edit in CodePen</a>\n      </li>\n      <li>\n        <a href="#" id="export-jsfiddle" data-i18n="menu.export.jsfiddle">Edit in JSFiddle</a>\n      </li>\n    </ul>\n  </li>\n  <li role="separator"></li>\n  <li>\n    <a href="#" id="deploy-link" data-i18n="menu.deploy">Deploy \u2026</a>\n  </li>\n  <li>\n    <a href="#" id="broadcast-link" data-i18n="menu.broadcast">Broadcast \u2026</a>\n  </li>\n  <li>\n    <a href="#" id="embed-link" data-i18n="menu.embed">Embed \u2026</a>\n  </li>\n  <li>\n    <a href="#" id="share-link">\n      <span data-i18n="menu.share">Share \u2026</span>\n      <span><kbd>Ctrl</kbd><kbd>Alt</kbd><kbd>S</kbd></span>\n    </a>\n  </li>\n  <li role="separator"></li>\n  <li>\n    <a href="#" id="info-link" data-i18n="menu.project">Project Info \u2026</a>\n  </li>\n  <li>\n    <a href="#" id="custom-settings-link" data-i18n="menu.customSettings">Custom Settings \u2026</a>\n  </li>\n  <li>\n    <a href="#" id="external-resources-link" data-i18n="menu.resources">External Resources \u2026</a>\n  </li>\n</ul>\n';

// src/livecodes/html/app-menu-settings.html?raw
var app_menu_settings_default = '<ul id="app-menu-settings" class="dropdown-menu">\n  <li class="link-and-switch">\n    <a href="#" id="welcome-link" data-i18n="menu.welcome.heading">Welcome \u2026</a>\n    <label\n      for="welcome"\n      class="switch"\n      title="Show Welcome screen on startup"\n      data-i18n="menu.showWelcome.title"\n      data-i18n-prop="title"\n    >\n      <div>\n        <input id="welcome" type="checkbox" data-config="welcome" />\n        <span class="slider round"></span>\n      </div>\n    </label>\n  </li>\n  <li role="separator"></li>\n  <li>\n    <label class="switch">\n      <span data-i18n="menu.autoUpdate">Auto Update</span>\n      <div>\n        <input id="autoupdate" type="checkbox" data-config="autoupdate" />\n        <span class="slider round"></span>\n      </div>\n    </label>\n  </li>\n  <li>\n    <label class="switch">\n      <span data-i18n="menu.autoSave">Auto Save</span>\n      <div>\n        <input id="autosave" type="checkbox" data-config="autosave" />\n        <span class="slider round"></span>\n      </div>\n    </label>\n  </li>\n  <li>\n    <label\n      class="range-slider-label"\n      title="Delay before auto-update"\n      data-i18n="menu.delay.hint"\n      data-i18n-prop="title"\n    >\n      <span data-i18n="menu.delay.heading" data-i18n-prop="innerHTML"\n        >Delay: <span id="delay-value">1.5</span>s</span\n      >\n      <div>\n        <input\n          type="range"\n          id="delay-range"\n          min="0"\n          max="3000"\n          step="250"\n          value="1500"\n          class="range-slider"\n        />\n      </div>\n    </label>\n  </li>\n  <li>\n    <label class="switch">\n      <span data-i18n="menu.formatOnsave">Format On-save</span>\n      <div>\n        <input id="formatOnsave" type="checkbox" data-config="formatOnsave" />\n        <span class="slider round"></span>\n      </div>\n    </label>\n  </li>\n  <li>\n    <label class="switch">\n      <span data-i18n="menu.recoverUnsaved">Recover Unsaved</span>\n      <div>\n        <input id="recover-unsaved" type="checkbox" data-config="recoverUnsaved" />\n        <span class="slider round"></span>\n      </div>\n    </label>\n  </li>\n  <li class="link-and-switch">\n    <a href="#" id="sync-link" data-i18n="menu.sync" data-i18n-prop="innerHTML"\n      >Sync (beta) \u2026 <span id="sync-indicator" class="smaller hidden"> \u23F3</span></a\n    >\n    <label for="autosync" class="switch">\n      <div>\n        <input id="autosync" type="checkbox" data-config="autosync" />\n        <span class="slider round"></span>\n      </div>\n    </label>\n  </li>\n  <li role="separator"></li>\n  <li>\n    <label class="switch">\n      <span data-i18n="menu.theme">Dark Theme</span>\n      <div>\n        <input id="theme" type="checkbox" data-config="theme" />\n        <span class="slider round"></span>\n      </div>\n    </label>\n  </li>\n  <li id="theme-color-item">\n    <span data-i18n="menu.themeColor">Color</span>\n    <span id="theme-color-selector"></span>\n  </li>\n  <li\n    data-i18n="menu.showSpacing.hint"\n    data-i18n-prop="title"\n    title="Press Alt/Option and move your cursor over result page"\n  >\n    <label class="switch">\n      <span data-i18n="menu.showSpacing.heading">Show Spacing</span>\n      <div>\n        <input id="show-spacing" type="checkbox" data-config="showSpacing" />\n        <span class="slider round"></span>\n      </div>\n    </label>\n  </li>\n  <li>\n    <label class="switch">\n      <span data-i18n="menu.layout">Vertical Layout</span>\n      <div>\n        <input id="layout" type="checkbox" data-config="layout" />\n        <span class="slider round"></span>\n      </div>\n    </label>\n  </li>\n  <li role="separator"></li>\n  <li>\n    <a href="#" id="assets-link" data-i18n="menu.assets">Assets \u2026</a>\n  </li>\n  <li>\n    <a href="#" id="snippets-link" data-i18n="menu.snippets">Code Snippets \u2026</a>\n  </li>\n  <li>\n    <a href="#" id="backup-link" data-i18n="menu.backup">Backup / Restore \u2026</a>\n  </li>\n  <li role="separator"></li>\n  <li>\n    <a href="#" id="editor-settings-link" data-i18n="menu.editorSettings">Editor Settings \u2026</a>\n  </li>\n</ul>\n';

// src/livecodes/html/app-menu-help.html?raw
var app_menu_help_default = '<ul id="app-menu-help" class="dropdown-menu">\n  <li>\n    <a href="#" id="command-menu-link">\n      <span data-i18n="menu.commandMenu">Command Menu</span>\n      <span><kbd>Ctrl</kbd><kbd>K</kbd></span>\n    </a>\n  </li>\n  <li>\n    <a href="#" id="keyboard-shortcuts-menu-link">\n      <span data-i18n="menu.keyboardShortcuts">Keyboard Shortcuts</span>\n    </a>\n  </li>\n  <li role="separator"></li>\n  <li>\n    <a href="https://blog.livecodes.io" target="_blank" rel="noopener" data-i18n="menu.blog"\n      >LiveCodes Blog</a\n    >\n  </li>\n  <li role="separator"></li>\n  <li>\n    <a href="{{DOCS_BASE_URL}}" target="_blank" rel="noopener" data-i18n="menu.docs"\n      >Documentation</a\n    >\n  </li>\n  <li>\n    <a\n      href="{{DOCS_BASE_URL}}getting-started"\n      target="_blank"\n      rel="noopener"\n      data-i18n="menu.getstart"\n      >Getting Started</a\n    >\n  </li>\n  <li>\n    <a href="{{DOCS_BASE_URL}}features" target="_blank" rel="noopener" data-i18n="menu.features"\n      >Features</a\n    >\n  </li>\n  <li>\n    <a href="{{DOCS_BASE_URL}}configuration" target="_blank" rel="noopener" data-i18n="menu.config"\n      >Configuration</a\n    >\n  </li>\n  <li>\n    <a href="{{DOCS_BASE_URL}}sdk" target="_blank" rel="noopener" data-i18n="menu.sdk">SDK</a>\n  </li>\n  <li>\n    <a href="{{DOCS_BASE_URL}}license" target="_blank" rel="noopener" data-i18n="menu.license"\n      >License</a\n    >\n  </li>\n  <li role="separator"></li>\n  <li>\n    <a href="{{REPO_URL}}/issues/new/choose" target="_blank" rel="noopener" data-i18n="menu.report"\n      >Report an issue</a\n    >\n  </li>\n  <li>\n    <a href="{{REPO_URL}}" target="_blank" rel="noopener" data-i18n="menu.source"\n      >Source code on GitHub</a\n    >\n  </li>\n  <li role="separator"></li>\n  <li><a href="#" id="about-link" data-i18n="menu.about">About ...</a></li>\n</ul>\n';

// src/livecodes/html/custom-settings.html?raw
var custom_settings_default = '<div id="custom-settings-container" class="modal-container">\n  <div class="modal-title" data-i18n="customSettings.heading">Custom Settings</div>\n  <div id="custom-settings-screen-container" class="modal-screen-container">\n    <div class="modal-screen">\n      <label data-i18n="customSettings.JSON">Custom Settings JSON</label>\n      <div id="custom-settings-editor" class="editor custom-editor"></div>\n      <button id="custom-settings-load-btn" class="wide-button" data-i18n="customSettings.load">\n        Load\n      </button>\n    </div>\n    <div class="description help" data-i18n="customSettings.desc" data-i18n-prop="innerHTML">\n      <i class="icon-help"></i>\n      For further details, please refer to the\n      <a href="{{DOCS_BASE_URL}}advanced/custom-settings" target="_blank" rel="noopener">\n        documentation\n      </a>\n    </div>\n  </div>\n</div>\n';

// src/livecodes/html/test-editor.html?raw
var test_editor_default = '<div id="test-editor-container" class="modal-container">\n  <div class="modal-title" data-i18n="testEditor.heading">Edit Tests</div>\n  <div id="test-editor-screen-container" class="modal-screen-container">\n    <div class="modal-screen">\n      <label data-i18n="testEditor.tests">Tests</label>\n      <div id="test-editor" class="editor custom-editor"></div>\n      <button id="test-load-btn" class="wide-button" data-i18n="testEditor.load">Load</button>\n    </div>\n    <div class="description help" data-i18n="testSettings.desc" data-i18n-prop="innerHTML">\n      <i class="icon-help"></i>\n      For further details, please refer to the\n      <a href="https://livecodes.io/docs/features/tests/" target="_blank" rel="noopener"\n        >documentation</a\n      >\n    </div>\n  </div>\n</div>\n';

// src/livecodes/html/welcome.html?raw
var welcome_default = '<div id="welcome-container" class="modal-container">\n  <div class="modal-title" style="height: auto;" data-i18n="welcome.heading">Welcome | \u062E\u0648\u0634 \u0622\u0645\u062F\u06CC\u062F</div>\n\n  <div id="welcome-screen-container" class="modal-screen-container">\n    <div class="modal-section" id="welcome-start">\n      <h3 data-i18n="welcome.start.heading">Start</h3>\n      <ul>\n        <li>\n          <a href="#" id="welcome-link-new">\n            <i class="icon-file-new"></i> <span data-i18n="welcome.start.new">New...</span></a\n          >\n        </li>\n        <li>\n          <a href="#" id="welcome-link-open">\n            <i class="icon-file-open"></i> <span data-i18n="welcome.start.open">Open...</span></a\n          >\n        </li>\n        <li>\n          <a href="#" id="welcome-link-import">\n            <i class="icon-file-import"></i>\n            <span data-i18n="welcome.start.import">Import...</span></a\n          >\n        </li>\n        <li class="default-template-li">\n          <span\n            id="no-default-template"\n            class="default-template"\n            data-i18n="welcome.start.noDefaultTemplate"\n            ><i class="icon-file-template"></i> No default template\n          </span>\n          <a href="#" id="welcome-link-load-default" class="default-template">\n            <i class="icon-file-template"></i>\n            <span data-i18n="welcome.start.loadDefaultTemplate">Load default template</span></a\n          >\n          <a\n            href="{{DOCS_BASE_URL}}features/default-template-language"\n            target="_blank"\n            id="welcome-default-template-info"\n            class="more"\n            title="Click for info..."\n            data-i18n="generic.clickForInfo"\n            data-i18n-prop="title"\n            ><i class="icon-info"></i\n          ></a>\n        </li>\n      </ul>\n    </div>\n\n    <div class="modal-section" id="welcome-recent">\n      <h3 data-i18n="welcome.recent.heading">Recent</h3>\n      <ul id="welcome-recent-list">\n        <li>\n          <a href="#" id="welcome-link-recent-open" class="more" data-i18n="generic.more"\n            >More...</a\n          >\n        </li>\n      </ul>\n    </div>\n\n    <div class="modal-section" id="welcome-templates">\n      <h3 data-i18n="welcome.templates.heading">Starter Templates</h3>\n      <ul id="welcome-template-list">\n        <li>\n          <a href="#" id="welcome-link-templates" class="more" data-i18n="generic.more">More...</a>\n        </li>\n      </ul>\n    </div>\n\n    <div class="modal-section" id="welcome-recover">\n      <h3 data-i18n="welcome.recover.heading">Recover</h3>\n      <div class="welcome-recover-content">\n        <div class="smaller" data-i18n="welcome.recover.unsavedChanges">\n          Your last project had unsaved changes:\n        </div>\n        <ul>\n          <li class="smaller overflow-ellipsis">\n            <i class="icon-edit"></i>\n            <span id="unsaved-project-name" class="overflow-ellipsis"></span>\n          </li>\n          <li class="smaller">\n            <i class="icon-calendar"></i>\n            <span data-i18n="welcome.recover.lastModified" data-i18n-prop="innerHTML"\n              >Last modified:</span\n            >\n            <span id="unsaved-project-last-modified"></span>\n          </li>\n        </ul>\n        <div class="welcome-recover-actions">\n          <a href="#" id="prompt-recover-btn" title="Recover project to editor">\n            <i class="icon-recover"></i>\n            <span data-i18n="welcome.recover.recover">Recover</span></a\n          >\n          <a href="#" id="prompt-save-previous-btn" title="Save to device and continue">\n            <i class="icon-save"></i>\n            <span data-i18n="welcome.recover.save">Save</span>\n          </a>\n          <a href="#" id="prompt-cancel-recover-btn">\n            <i class="icon-delete"></i>\n            <span data-i18n="welcome.recover.cancel">Cancel</span>\n          </a>\n        </div>\n      </div>\n    </div>\n\n    <div class="modal-section" id="welcome-about">\n      <h3 data-i18n="welcome.about.heading">About NitroCode Live Code</h3>\n      <ul class="modal-docs">\n        <!-- <li>\n          <a\n            href="{{DOCS_BASE_URL}}"\n            target="_blank"\n            rel="noopener"\n            data-i18n="welcome.about.documentation"\n            >Documentation</a\n          >\n        </li>\n        <li>\n          <a\n            href="{{DOCS_BASE_URL}}getting-started"\n            target="_blank"\n            rel="noopener"\n            data-i18n="generic.about.gettingStarted"\n            >Getting Started</a\n          >\n        </li>\n        <li>\n          <a\n            href="{{DOCS_BASE_URL}}configuration"\n            target="_blank"\n            rel="noopener"\n            data-i18n="generic.about.configuration"\n            >Configuration</a\n          >\n        </li>\n        <li>\n          <a\n            href="{{DOCS_BASE_URL}}sdk"\n            target="_blank"\n            rel="noopener"\n            data-i18n="generic.about.sdk"\n            >LiveCodes SDK</a\n          >\n        </li> -->\n      </ul>\n\n      <div class="livecodes-support">\n        <!-- <div>\n          <a\n            href="{{DOCS_BASE_URL}}sponsor"\n            target="_blank"\n            rel="noopener"\n            title="Sponsor LiveCodes"\n          >\n            <i class="icon-sponsor"></i>\n            <br /><span data-i18n="generic.about.sponsor">Sponsor</span></a\n          >\n        </div> -->\n        <div>\n          <a href="https://nitrocode.ir/posts" target="_blank" rel="noopener" title="NitroCode.ir Blog">\n            <i class="icon-blog"></i>\n            <br /><span data-i18n="generic.about.blog">Blog</span></a\n          >\n        </div>\n        <!-- <div>\n          <a\n            href="https://twitter.com/livecodes_io"\n            target="_blank"\n            rel="noopener"\n            title="\u{1D54F} / Twitter"\n          >\n            <i class="icon-share-x"></i>\n            <br /><span data-i18n="generic.about.twitter">\u{1D54F} / Twitter</span></a\n          >\n        </div> -->\n        <div>\n          <a href="https://github.com/benkhalife" target="_blank" rel="noopener" title="GitHub">\n            <i class="icon-github"></i>\n            <br />\n            <span data-i18n="generic.about.github">GitHub</span></a\n          >\n        </div>\n      </div>\n    </div>\n  </div>\n\n  <div id="welcome-show">\n    <input type="checkbox" value="welcome-show-checkbox" id="welcome-show-checkbox" checked />\n    <label for="welcome-show-checkbox" data-i18n="welcome.showOnStartup">Show on startup</label>\n  </div>\n</div>\n';

// src/livecodes/html/about.html?raw
var about_default = '<div id="about-container" class="modal-container">\n  <div class="modal-title" data-i18n="about.heading">About LiveCodes</div>\n  <div id="about-screen-container" class="modal-screen-container">\n    <div\n      class="about-logo"\n      title="LiveCodes: A Code Playground That Just Works!"\n      data-i18n="app.logo.title"\n      data-i18n-prop="title"\n    >\n      <img\n        src="livecodes/assets/images/livecodes-text-logo-nowrap.svg"\n        width="280"\n        height="auto"\n        alt="LiveCodes logo"\n      />\n    </div>\n\n    <div class="modal-section">\n      <h3 data-i18n="about.version.heading">Version</h3>\n      <ul class="about-version">\n        <li data-i18n="about.version.app" data-i18n-prop="innerHTML">\n          App version: <span class="version">{{APP_VERSION}}</span>\n        </li>\n        <li data-i18n="about.version.sdk" data-i18n-prop="innerHTML">\n          SDK version: <span class="version">{{SDK_VERSION}}</span>\n        </li>\n        <li data-i18n="about.version.commit" data-i18n-prop="innerHTML">\n          Git commit:\n          <a href="{{COMMIT_URL}}" target="_blank" rel="noopener" class="version">{{COMMIT_SHA}}</a>\n        </li>\n        <li>\n          <a\n            data-i18n="about.version.appPermanentUrl"\n            href="{{APP_URL}}"\n            target="_blank"\n            rel="noopener"\n            >App Permanent URL</a\n          >\n        </li>\n        <li>\n          <a\n            data-i18n="about.version.sdkPermanentUrl"\n            href="{{SDK_URL}}"\n            target="_blank"\n            rel="noopener"\n            >SDK Permanent URL</a\n          >\n        </li>\n      </ul>\n      <h3 data-i18n="about.credits.heading">Credits</h3>\n      <p data-i18n="about.credits.para1" data-i18n-prop="innerHTML">\n        LiveCodes is made possible by open source projects, web services and contributors.\n        <a href="{{DOCS_BASE_URL}}credits" target="_blank">View Credits</a>\n      </p>\n      <p data-i18n="about.credits.para2">\n        \xA9 2024 Hatem Hosny. LiveCodes is licensed under MIT License.\n      </p>\n    </div>\n\n    <div class="modal-section" id="about-info">\n      <h3 data-i18n="about.livecodes.aboutUs">About LiveCodes</h3>\n      <p data-i18n="about.livecodes.para1" data-i18n-prop="innerHTML">\n        <strong><em>LiveCodes</em></strong> is an open-source, feature-rich, client-side code\n        playground. Currently, 90+ languages and frameworks are supported. It can be used as a\n        standalone app or embedded in any web page.\n      </p>\n      <p data-i18n="about.livecodes.para2" data-i18n-prop="innerHTML">\n        A powerful SDK makes it easy to integrate and communicate with playgrounds. Extensive\n        documentation is available with code examples, live demos, and screenshots.\n      </p>\n      <h3 data-i18n="about.documentations.heading">Documentations</h3>\n      <ul class="modal-docs">\n        <li>\n          <a\n            href="{{DOCS_BASE_URL}}getting-started"\n            target="_blank"\n            rel="noopener"\n            data-i18n="about.gettingStarted"\n            >Getting Started</a\n          >\n        </li>\n        <li>\n          <a\n            href="{{DOCS_BASE_URL}}"\n            target="_blank"\n            rel="noopener"\n            data-i18n="about.documentations.heading"\n            >Documentations</a\n          >\n        </li>\n        <li>\n          <a\n            href="{{DOCS_BASE_URL}}configuration"\n            target="_blank"\n            rel="noopener"\n            data-i18n="about.configuration"\n            >Configuration</a\n          >\n        </li>\n        <li>\n          <a href="{{DOCS_BASE_URL}}sdk" target="_blank" rel="noopener" data-i18n="about.sdk"\n            >LiveCodes SDK</a\n          >\n        </li>\n      </ul>\n\n      <div class="livecodes-support">\n        <div>\n          <a\n            href="{{DOCS_BASE_URL}}sponsor"\n            target="_blank"\n            rel="noopener"\n            title="Sponsor LiveCodes"\n            data-i18n="about.sponsor.title"\n            data-i18n-prop="title"\n          >\n            <i class="icon-sponsor"></i>\n            <br /><span data-i18n="about.sponsor.text">Sponsor</span></a\n          >\n        </div>\n        <div>\n          <a\n            href="https://blog.livecodes.io"\n            target="_blank"\n            rel="noopener"\n            title="LiveCodes Blog"\n            data-i18n="about.blog.title"\n            data-i18n-prop="title"\n          >\n            <i class="icon-blog"></i>\n            <br /><span data-i18n="about.blog.text">Blog</span></a\n          >\n        </div>\n        <div>\n          <a\n            href="https://twitter.com/livecodes_io"\n            target="_blank"\n            rel="noopener"\n            title="\u{1D54F} / Twitter"\n            data-i18n="about.twitter.title"\n            data-i18n-prop="title"\n          >\n            <i class="icon-share-x"></i>\n            <br /><span data-i18n="about.twitter.text">\u{1D54F} / Twitter</span></a\n          >\n        </div>\n        <div>\n          <a\n            href="{{REPO_URL}}"\n            target="_blank"\n            rel="noopener"\n            title="GitHub"\n            data-i18n="about.github.title"\n            data-i18n-prop="title"\n          >\n            <i class="icon-github"></i>\n            <br /><span data-i18n="about.github.text">GitHub</span></a\n          >\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n';

// src/livecodes/html/project-info.html?raw
var project_info_default = `<div id="info-container" class="modal-container">
  <div class="modal-title" data-i18n="project.heading">Project Info</div>
  <div id="info-screen-container" class="modal-screen-container">
    <div class="modal-screen">
      <label for="title-input" data-i18n="project.title">Project Title</label>
      <input id="title-input" type="text" spellcheck="false" />
      <label for="description-textarea" data-i18n="project.desc">Description</label>
      <textarea id="description-textarea"></textarea>
      <label for="head-textarea" data-i18n="project.head" data-i18n-prop="innerHTML"
        >Add to &lt;head&gt;</label
      >
      <textarea
        dir="ltr"
        id="head-textarea"
        placeholder='&lt;meta name="viewport" content="width=device-width, initial-scale=1.0" /&gt;'
        spellcheck="false"
      ></textarea>
      <label for="html-attrs-textarea" data-i18n="project.htmlAttr" data-i18n-prop="innerHTML"
        >Attributes for &lt;html&gt;</label
      >
      <textarea
        dir="ltr"
        id="html-attrs-textarea"
        placeholder='lang="en" class="my-class"'
        spellcheck="false"
      ></textarea>
      <label for="tags-input" data-i18n="project.tags">Tags</label>
      <input id="tags-input" type="text" spellcheck="false" />
    </div>
  </div>
</div>
`;

// src/livecodes/html/keyboard-shortcuts.html?raw
var keyboard_shortcuts_default = '<div id="keyboard-shortcuts-container" class="modal-container">\n  <div class="modal-title" data-i18n="keyboardShortcuts.heading">Keyboard Shortcuts</div>\n  <div id="keyboard-shortcuts-screen-container" class="modal-screen-container">\n    <div id="keyboard-shortcuts-status" class="modal-status"></div>\n\n    <div class="modal-screen">\n      <div\n        class="description help"\n        data-i18n="keyboardShortcuts.editorShortcuts"\n        data-i18n-prop="innerHTML"\n      >\n        For the list of code editor keyboard shortcuts, see\n        <a\n          href="https://code.visualstudio.com/docs/getstarted/keybindings#_basic-editing"\n          target="_blank"\n          rel="noopener"\n        >\n          VS Code shortcuts</a\n        >\n      </div>\n\n      <div id="keyboard-shortcuts-table-container">\n        <table id="keyboard-shortcuts-table">\n          <thead>\n            <tr>\n              <th data-i18n="keyboardShortcuts.command">Command</th>\n              <th data-i18n="keyboardShortcuts.key">Key</th>\n            </tr>\n          </thead>\n          <tbody></tbody>\n        </table>\n      </div>\n    </div>\n  </div>\n</div>\n';

// src/livecodes/html/login.html?raw
var login_default = '<div id="login-screen" class="modal-container">\n  <div class="modal-title" data-i18n="login.heading">Login with GitHub</div>\n  <div class="modal-screen-container">\n    <div class="modal-content">\n      <p data-i18n="login.accessAllowed">Allow access to:</p>\n      <div class="login-access">\n        <input\n          type="checkbox"\n          value="public_repo"\n          id="public_repo"\n          name="public_repo"\n          checked="checked"\n        />\n        <label for="public_repo" data-i18n="login.publicRepo">Repos</label>\n        <div class="indent">\n          <input type="checkbox" value="repo" id="repo" name="repo" checked="checked" /><label\n            for="repo"\n            data-i18n="login.privateRepo"\n          >\n            Private Repos</label\n          >\n        </div>\n        <input type="checkbox" value="gist" id="gist" name="gist" checked="checked" /><label\n          for="gist"\n          data-i18n="login.gist"\n        >\n          Gists</label\n        >\n      </div>\n      <div class="buttons">\n        <button id="login-btn" class="button" data-i18n="login.loginBtn">Login</button>\n      </div>\n    </div>\n\n    <div class="description confirm" data-i18n="login.desc" data-i18n-prop="innerHTML">\n      <p>By logging in, you agree that <strong>cookies</strong> may be stored on your device.</p>\n      <p>\n        <a\n          href="{{DOCS_BASE_URL}}features/github-integration#features-that-require-github-account"\n          target="_blank"\n          rel="noopener"\n          >Why are these permissions required?</a\n        >\n      </p>\n      <p>\n        <a\n          href="{{DOCS_BASE_URL}}features/github-integration#setting-permissions"\n          target="_blank"\n          rel="noopener"\n          >How to change/revoke permissions?</a\n        >\n      </p>\n    </div>\n  </div>\n</div>\n';
...
var menuProjectHTML = /* @__PURE__ */ replaceValues(app_menu_project_default);
var menuSettingsHTML = /* @__PURE__ */ replaceValues(app_menu_settings_default);
var menuHelpHTML = /* @__PURE__ */ replaceValues(app_menu_help_default);
var customSettingsScreen = /* @__PURE__ */ replaceValues(custom_settings_default);
var testEditorScreen = /* @__PURE__ */ replaceValues(test_editor_default);
var welcomeScreen = /* @__PURE__ */ replaceValues(welcome_default);
var aboutScreen = /* @__PURE__ */ replaceValues(about_default);
var infoScreen = /* @__PURE__ */ replaceValues(project_info_default);
var keyboardShortcutsScreen = /* @__PURE__ */ replaceValues(keyboard_shortcuts_default);
var loginScreen = /* @__PURE__ */ replaceValues(login_default);
...
var templatesScreen = /* @__PURE__ */ replaceValues(templates_default);
var resultPopupHTML = /* @__PURE__ */ replaceValues(result_popup_default);
...
var bbobHtmlUrl = /* @__PURE__ */ getUrl("@bbob/html@4.3.1/dist/index.min.js");
var bbobPresetHtmlUrl = /* @__PURE__ */ getUrl(
...
var fontInterUrl = /* @__PURE__ */ getUrl(
...
var fontMaterialIconsUrl = /* @__PURE__ */ getUrl(
...
var fscreenUrl = /* @__PURE__ */ getUrl("fscreen@1.2.0/dist/fscreen.esm.js");
...
var jestTypesUrl = /* @__PURE__ */ getUrl("@types/jest@27.4.1/index.d.ts");
...
var ninjaKeysUrl = /* @__PURE__ */ getUrl("@hatemhosny/ninja-keys@1.14.0/bundle/index.js");
...
var svelteBaseUrl = /* @__PURE__ */ getUrl("svelte@5.39.12/");
...
var typescriptUrl = /* @__PURE__ */ getUrl(`typescript@5.9.3/lib/typescript.js`);
...
var createProjectInfoUI = async (config, storage, modal2, onUpdate) => {
  const div = document.createElement("div");
  div.innerHTML = infoScreen;
  const projectInfoContainer = div.firstChild;
  modal2.show(projectInfoContainer, { onClose: () => updateInfo(), autoFocus: false });
  const titleInput = getInfoTitleInput();
  titleInput.value = config.title;
  titleInput.focus();
  const descriptionTextarea = getInfoDescription();
  descriptionTextarea.value = config.description;
  const headTextarea = getInfoHead();
  headTextarea.value = config.head;
  const htmlAttrsTextarea = getInfoHtmlAttrs();
  htmlAttrsTextarea.value = typeof config.htmlAttrs === "string" ? config.htmlAttrs : JSON.stringify(config.htmlAttrs, null, 2);
  const tagsInput = getInfoTagsInput();
  tagsInput.value = removeDuplicates(config.tags).join(", ");
  const updateInfo = async () => {
    getProjectTitleElement().textContent = titleInput.value;
    onUpdate(
      titleInput.value,
...
var getToolbarElement = () => document.querySelector("#toolbar");
var getProjectTitleElement = () => document.querySelector("#project-title");
var getEditorContainerElement = () => document.querySelector("#editor-container");
var getEditorsElement = () => document.querySelector("#editors");
...
var getOutputElement = () => document.querySelector("#output");
var getResultElement = () => document.querySelector("#result");
var getResultIFrameElement = () => document.querySelector("#result > iframe");
var getGutterElement = () => document.querySelector("#editor-container .gutter");
var getLogoLink = () => document.querySelector("a#logo");
var getRunButton = () => document.querySelector("#run-button");
...
var getI18nMenuButton = () => document.querySelector("#app-menu-button-i18n");
var getI18nMenuContainer = () => document.querySelector("#app-menu-container-i18n");
var getMarkupEditorTitle = () => document.querySelector("#markup-selector");
var getStyleEditorTitle = () => document.querySelector("#style-selector");
var getScriptEditorTitle = () => document.querySelector("#script-selector");
var getEditorToolbar = () => document.querySelector("#editor-tools");
var getFocusButton = () => document.querySelector("#editor-tools #focus-btn");
var getCopyButton = () => document.querySelector("#editor-tools #copy-btn");
var getCopyAsUrlButton = () => document.querySelector("#editor-tools #copy-as-url-btn");
var getCodeToImageButton = () => document.querySelector("#editor-tools #code-to-img-btn");
var getUndoButton = () => document.querySelector("#editor-tools #undo-btn");
var getRedoButton = () => document.querySelector("#editor-tools #redo-btn");
...
var getEditorStatus = () => document.querySelector("#editor-tools #editor-status");
...
var getEditorSettingsBtn = () => document.querySelector("#editor-tools #editor-settings-btn");
var getShareButton = () => document.querySelector("#share-button");
var getResultButton = () => document.querySelector("#result-button");
var getFullscreenButton = () => document.querySelector("#fullscreen-button");
...
var getToolspaneElement = () => document.querySelector("#output #tools-pane");
var getToolspaneBar = () => document.querySelector("#output #tools-pane-bar");
var getToolspaneButtons = () => document.querySelector("#tools-pane-buttons");
var getToolspaneTitles = () => document.querySelector("#tools-pane-titles");
var getConsoleButton = () => document.querySelector("#tools-pane-titles > .console");
var getCompiledButton = () => document.querySelector("#tools-pane-titles > .compiled");
var getTestsButton = () => document.querySelector("#tools-pane-titles > .tests");
var getToolspaneLoader = () => document.querySelector("#tools-pane-loading");
var getZoomButton = () => document.querySelector("#zoom-button");
var getZoomButtonValue = () => document.querySelector("#zoom-button #zoom-value");
var getResultPopupButton = () => document.querySelector("#result-popup-btn");
...
var getLanguageMenuLinks = () => document.querySelectorAll("#select-editor .language-item a");
var getLanguageMenuButtons = () => document.querySelectorAll("#select-editor .language-menu-button");
var getstyleMenu = () => document.querySelector("#style-selector .dropdown-menu");
var getSettingToggles = () => document.querySelectorAll("#app-menu-settings input");
var getThemeColorSelector = () => document.querySelector("#app-menu-settings #theme-color-selector");
var getAppMenuProjectScroller = () => document.querySelector("#app-menu-container-project");
var getAppMenuProjectButton = () => document.querySelector("#app-menu-button-project");
var getAppMenuSettingsScroller = () => document.querySelector("#app-menu-container-settings");
var getAppMenuSettingsButton = () => document.querySelector("#app-menu-button-settings");
var getAppMenuHelpScroller = () => document.querySelector("#app-menu-container-help");
var getAppMenuHelpButton = () => document.querySelector("#app-menu-button-help");
var getExportJSONLink = () => document.querySelector("#export-menu #export-json");
var getExportResultLink = () => document.querySelector("#export-menu #export-result");
var getExportSourceLink = () => document.querySelector("#export-menu #export-src");
var getExportGithubGistLink = () => document.querySelector("#export-menu #export-githubGist");
var getExportCodepenLink = () => document.querySelector("#export-menu #export-codepen");
var getExportJsfiddleLink = () => document.querySelector("#export-menu #export-jsfiddle");
var getLoginLink = () => document.querySelector("#login-link");
var getLogoutLink = () => document.querySelector("#logout-link");
var getNewLink = () => document.querySelector("#new-link");
var getOpenLink = () => document.querySelector("#open-link");
var getSaveLink = () => document.querySelector("#save-link");
var getForkLink = () => document.querySelector("#fork-link");
var getSaveAsTemplateLink = () => document.querySelector("#template-link");
var getExternalResourcesLink = () => document.querySelector("#external-resources-link");
var getCustomSettingsLink = () => document.querySelector("#custom-settings-link");
var getShareLink = () => document.querySelector("#share-link");
var getEmbedLink = () => document.querySelector("#embed-link");
var getEditorSettingsLink = () => document.querySelector("#editor-settings-link");
var getDeployLink = () => document.querySelector("#deploy-link");
var getSyncLink = () => document.querySelector("#sync-link");
var getImportLink = () => document.querySelector("#import-link");
var getBackupLink = () => document.querySelector("#backup-link");
var getBroadcastLink = () => document.querySelector("#broadcast-link");
var getWelcomeLink = () => document.querySelector("#welcome-link");
var getAboutLink = () => document.querySelector("#about-link");
var getCommandMenuLink = () => document.querySelector("#command-menu-link");
var getKeyboardShortcutsMenuLink = () => document.querySelector("#keyboard-shortcuts-menu-link");
...
var getThemeColorContainer = () => document.querySelector("#theme-color-selector");
var getCustomThemeColorInput = () => document.querySelector("#theme-color-custom");
...
var getProjectInfoLink = () => document.querySelector("#app-menu-project #info-link");
var getAssetsLink = () => document.querySelector("#app-menu-settings #assets-link");
var getSnippetsLink = () => document.querySelector("#app-menu-settings #snippets-link");
var getHelpMenu = () => document.querySelector("#app-menu-help");
var getInfoTitleInput = () => document.querySelector("#info-container input#title-input");
var getInfoHead = () => document.querySelector("#info-container #head-textarea");
var getInfoHtmlAttrs = () => document.querySelector("#info-container #html-attrs-textarea");
var getInfoDescription = () => document.querySelector("#info-container #description-textarea");
var getInfoTagsInput = () => document.querySelector("#info-container input#tags-input");
var getCustomSettingsEditor = () => document.querySelector("#custom-settings-container #custom-settings-editor");
var getLoadCustomSettingsButton = () => document.querySelector("#custom-settings-container #custom-settings-load-btn");
var getTestEditor = () => document.querySelector("#test-editor-container #test-editor");
var getLoadTestsButton = () => document.querySelector("#test-editor-container #test-load-btn");
var getEditTestsButton = () => document.querySelector("#test-container #edit-tests-btn");
var getRunTestsButton = () => document.querySelector("#test-container #run-tests-btn");
var getWatchTestsButton = () => document.querySelector("#test-container #watch-tests-btn");
var getStarterTemplatesTab = (templatesContainer) => templatesContainer.querySelector(
  '#templates-tabs [data-target="templates-starter"]'
);
var getStarterTemplatesList = (templatesContainer) => templatesContainer.querySelector("#starter-templates-list");
var getUserTemplatesScreen = (templatesContainer) => templatesContainer.querySelector("#templates-user .modal-screen");
var getBroadcastStatusBtn = () => document.querySelector("#broadcast-status-btn");
var getWelcomeLinkNew = (welcomeContainer) => welcomeContainer.querySelector("#welcome-link-new");
var getWelcomeLinkOpen = (welcomeContainer) => welcomeContainer.querySelector("#welcome-link-open");
var getWelcomeLinkImport = (welcomeContainer) => welcomeContainer.querySelector("#welcome-link-import");
var getWelcomeLinkDefaultTemplateLi = (welcomeContainer) => welcomeContainer.querySelector(".default-template-li");
var getWelcomeLinkNoDefaultTemplate = (welcomeContainer) => welcomeContainer.querySelector("#no-default-template");
var getWelcomeLinkLoadDefault = (welcomeContainer) => welcomeContainer.querySelector("#welcome-link-load-default");
var getWelcomeLinkRecentOpen = (welcomeContainer) => welcomeContainer.querySelector("#welcome-link-recent-open");
var getWelcomeLinkTemplates = (welcomeContainer) => welcomeContainer.querySelector("#welcome-link-templates");
var getModalShowWelcomeCheckbox = (welcomeContainer) => welcomeContainer.querySelector("#modal #welcome-show-checkbox");
var getModalWelcomeRecover = (welcomeContainer = document) => welcomeContainer.querySelector("#modal #welcome-recover");
var getModalWelcomeScreen = (welcomeContainer) => welcomeContainer.querySelector("#modal #welcome-screen-container");
var getModalWelcomeRecent = (welcomeContainer) => welcomeContainer.querySelector("#modal #welcome-recent");
var getModalWelcomeRecentList = (welcomeContainer) => welcomeContainer.querySelector("#modal #welcome-recent-list");
var getModalWelcomeTemplateList = (welcomeContainer) => welcomeContainer.querySelector("#modal #welcome-template-list");
...
var createLoginContainer = (eventsManager2, loginCallback) => {
  const div = document.createElement("div");
  div.innerHTML = loginScreen;
  const loginContainer = div.firstChild;
  const reposCheckBox = loginContainer.querySelector("#public_repo");
  const privateReposCheckBox = loginContainer.querySelector("#repo");
  const gistsCheckBox = loginContainer.querySelector("#gist");
  ...
  eventsManager2.addEventListener(
    ...
    () => {
      const scopes = [
        ...reposCheckBox.checked && !privateReposCheckBox.checked ? [reposCheckBox.value] : [],
        ...privateReposCheckBox.checked ? [privateReposCheckBox.value] : [],
        ...gistsCheckBox.checked ? [gistsCheckBox.value] : []
      ];
...
var createOpenItem = (item, list, getLanguageTitle2, getLanguageByAlias2, isTemplate = false) => {
...
var Split = function(idsOption, options) {
  ...
  var parent2 = firstElement.parentNode;
  var parentStyle = getComputedStyle ? getComputedStyle(parent2) : null;
  ...
  function trimToMin(sizesToTrim) {
    var parentSize = innerSize(parent2);
    if (parentSize === null) {
      return sizesToTrim;
    }
  ...
  function stopDragging() {
    ...
    global2[removeEventListener2]("mouseup", self2.stop);
    global2[removeEventListener2]("touchend", self2.stop);
    global2[removeEventListener2]("touchcancel", self2.stop);
    global2[removeEventListener2]("mousemove", self2.move);
    global2[removeEventListener2]("touchmove", self2.move);
    self2.stop = null;
    self2.move = null;
  ...
  function startDragging(e) {
    ...
    global2[addEventListener2]("mouseup", self2.stop);
    global2[addEventListener2]("touchend", self2.stop);
    global2[addEventListener2]("touchcancel", self2.stop);
    global2[addEventListener2]("mousemove", self2.move);
    global2[addEventListener2]("touchmove", self2.move);
  ...
  elements = ids.map(function(id2, i) {
    ...
    if (i > 0) {
      ...
      gutterElement[addEventListener2](
        "mousedown",
      ...
      parent2.insertBefore(gutterElement, element.element);
  ...
  function destroy2(preserveStyles, preserveGutter) {
    pairs.forEach(function(pair) {
      if (preserveGutter !== true) {
        pair.parent.removeChild(pair.gutter);
      } else {
        pair.gutter[removeEventListener2](
          "mousedown",
          pair[gutterStartDragging]
        );
        pair.gutter[removeEventListener2](
...
var createEventsManager = () => {
  const events = [];
  const addEventListener3 = (element, eventType, fn, options) => {
    if (!element)
      return;
  ...
  const removeEventListener3 = (element, eventType, fn) => {
    if (!element)
      return;
  ...
  return {
    addEventListener: addEventListener3,
    removeEventListener: removeEventListener3,
    removeEventListeners
  };
};
...
// src/livecodes/UI/split-panes.ts
var createSplitPanes = (layout = "horizontal") => {
  let destroyed = false;
  let split2;
  const init = () => {
    destroy2(false, false);
    setLayout2(layout);
    destroyed = false;
    const gutterSize = layout === "vertical" ? 8 : 10;
    split2 = split_es_default(["#editors", "#output"], {
      direction: layout,
      minSize: [0, 0],
      gutterSize,
      elementStyle: (_dimension, size, gutterSize2) => {
        window.dispatchEvent(new Event(customEvents.resizeEditor));
        return {
          "flex-basis": `calc(${size}% - ${gutterSize2}px)`
        };
      },
      gutterStyle: (_dimension, gutterSize2) => ({
  ...
  const setAnimation = (animate) => {
    const editorsElement = document.querySelector("#editors");
    const outputElement = document.querySelector("#output");
    if (!outputElement || !editorsElement)
      return;
    if (animate) {
  ...
  const show = (pane, full) => {
    ...
    if (pane === "code" && (split2.getSizes()[0] < 10 || full)) {
      split2.setSizes(codeOpen);
    } else if (pane === "output" && (split2.getSizes()[1] < 10 || full)) {
      split2.setSizes(outputOpen);
    } else if (pane === "toggle" && (split2.getSizes()[1] < 10 || full)) {
      if (split2.getSizes()[0] < 10) {
        split2.setSizes(codeOpen);
      } else {
        split2.setSizes(outputOpen);
      }
  ...
  const destroy2 = (preserveStyles, preserveGutters) => {
    if (!destroyed) {
      split2?.destroy(preserveStyles, preserveGutters);
      destroyed = true;
    }
  };
  init();
...
var createTemplatesContainer = (eventsManager2, loadUserTemplates) => {
  const div = document.createElement("div");
  div.innerHTML = templatesScreen;
  const templatesContainer = div.firstChild;
  const tabs = templatesContainer.querySelectorAll("#templates-tabs li");
  tabs.forEach((tab) => {
    const link = tab.querySelector("a");
    if (!link)
      return;
    eventsManager2.addEventListener(link, "click", () => {
...
var createStarterTemplateLink = (template, starterTemplatesList, baseUrl2) => {
  const li = document.createElement("li");
  const link = document.createElement("a");
  link.href = "?template=" + template.name;
  link.innerHTML = `
<img src="${baseUrl2 + template.thumbnail}" />
...
var getLanguageByAlias = (alias = "") => {
  ...
  return window.deps.languages.find(
    (language) => language.name === aliasLowerCase || language.title.toLowerCase() === aliasLowerCase || language.extensions.map((ext2) => ext2.toLowerCase()).includes(aliasLowerCase)
  )?.name;
};
...
var bbcode = {
  ...
  compiler: {
    url: bbobHtmlUrl,
    factory: () => {
      self.importScripts(bbobPresetHtmlUrl);
      return async (code) => self.BbobHtml.default(code, self.BbobPresetHTML5.default());
    }
  },
...
var hasUrlImportsOrExports = (code) => new RegExp(
...
var createCSSModulesImportMap = (compiledScript, compiledStyle, cssTokens = {}, extension = "css") => {
  ...
  const filenames = [
    ...extensions.map((ext2) => "./style." + ext2),
    ...extensions.map((ext2) => "./styles." + ext2),
    ...extensions.map((ext2) => "./style.module." + ext2),
    ...extensions.map((ext2) => "./styles.module." + ext2)
  ];
...
var fetchUserName = async (user) => {
  ...
  const login2 = userInfo.login;
  saveUsername(uid, login2);
  return login2;
};
...
var ext = serviceBaseUrl === localBaseUrl ? ".html" : "";
var sandboxService = {
...
var removeCDNPrefix = (url3) => {
  ...
  for (const prefix of prefixes) {
    if (url3.startsWith(prefix)) {
      return url3.replace(prefix, "");
    }
  }
  return url3;
};
var removeSpecifier = (type2) => type2.includes(":") && !type2.startsWith("data:") && !type2.startsWith("http") ? type2.split(":")[1] : type2;

// src/livecodes/services/types.ts
var typesService = {
  getTypeUrls: async (types) => {
    const fetchedTypes = {};
    await Promise.all(
      types.map(async (type2) => {
        const mod = removeSpecifier(removeCDNPrefix(type2));
        if (!isBare(mod))
          return;
        try {
  ...
  getTypesAsImports: (types) => types.map((type2, i) => {
    const mod = removeSpecifier(removeCDNPrefix(type2));
    if (!isBare(mod))
      return "";
    return `import * as x${i} from '${type2}';`;
  }).join("\n")
};
...
var getCommandMenuActions = ({
  deps
}) => {
  const { getConfig: getConfig2, loadStarterTemplate: loadStarterTemplate2, changeEditorSettings: changeEditorSettings2, changeLayout } = deps;
  const config = getConfig2();
  const getContent = (content) => config.appLanguage && config.appLanguage !== "en" ? content : void 0;
  const actions = [
    {
      id: "Show",
      ...
      children: [
        ...
        },
        {
          ...
          mdIcon: "terminal",
          handler: () => {
            getConsoleButton()?.dispatchEvent(new Event("touchstart"));
          }
        },
        {
          id: "Maximize Console",
          ...
          mdIcon: "terminal",
          handler: () => {
            getConsoleButton()?.dispatchEvent(new Event("dblclick"));
          }
        },
        {
          ...
          handler: () => {
            getCompiledButton()?.dispatchEvent(new Event("touchstart"));
          }
        },
        {
          ...
          icon: icons.code_blocks,
          handler: () => {
            getCompiledButton()?.dispatchEvent(new Event("dblclick"));
          }
        },
        {
          id: "Toggle Tests",
          ...
          icon: icons.labs,
          handler: () => {
            getTestsButton()?.dispatchEvent(new Event("touchstart"));
          }
        },
        {
          id: "Maximize Tests",
          ...
          icon: icons.labs,
          handler: () => {
            getTestsButton()?.dispatchEvent(new Event("dblclick"));
          }
        },
        {
    ...
    },
    {
      ...
      mdIcon: "code",
      children: window.deps.languages.filter((l) => languageIsEnabled(l.name, getConfig2())).sort((a, b) => a.title.localeCompare(b.title)).map((lang) => ({
        id: "Language: " + lang.title,
        title: lang.longTitle ?? lang.title,
        keywords: [lang.name, lang.title, lang.longTitle, ...lang.extensions].join(", "),
        handler: async () => {
          document.querySelector('a[data-editor][data-lang="' + lang.name + '"]')?.click();
        }
      }))
    },
    {
      ...
      children: window.deps.processors.filter((p) => !p.hidden && processorIsEnabled(p.name, getConfig2())).map((processor) => ({
        id: "Processor: " + processor.title,
        title: window.deps.translateString("commandMenu.toggle", "Toggle: ") + (processor.longTitle ?? processor.title),
    ...
    },
    {
      ...
      children: stringUnionToArray()(
        ...
        handler: async () => {
          await loadStarterTemplate2(template);
        }
      }))
    },
    {
    ...
    },
    {
      ...
      mdIcon: "file_present",
      handler: () => {
        getExternalResourcesLink()?.click();
      }
    },
    {
      id: "Assets",
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          mdIcon: "toggle_on",
          handler: () => {
            changeEditorSettings2({ enableAI: true });
          }
        },
        {
          ...
          mdIcon: "toggle_off",
          handler: () => {
            changeEditorSettings2({ enableAI: false });
          }
        },
        {
        ...
        },
        {
          ...
          mdIcon: "edit",
          handler: () => {
            changeEditorSettings2({ editorMode: "vim" });
          }
        },
        {
          id: "Disable Vim Mode",
          ...
          mdIcon: "edit_off",
          handler: () => {
            changeEditorSettings2({ editorMode: void 0 });
          }
        },
        {
          ...
          mdIcon: "edit",
          handler: () => {
            changeEditorSettings2({ editorMode: "emacs" });
          }
        },
        {
    ...
    },
    {
      ...
      children: Object.entries(appLanguages).map(([key, lang]) => ({
        ...
        title: lang,
        keywords: key,
        matcher: (_action, { searchString }) => key.includes(searchString.toLowerCase()) || lang.includes(searchString),
        handler: async () => {
          document.querySelector('#app-menu-i18n a[data-lang="' + key + '"]')?.click();
        }
      }))
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          mdIcon: "palette",
          handler: () => {
            getCustomThemeColorInput()?.click();
          }
        },
        {
          ...
          mdIcon: "palette",
          handler: () => {
            getThemeColorContainer()?.querySelector("input")?.click();
          }
        },
        {
          id: "editor theme",
      ...
      children: [
        {
          ...
          mdIcon: "menu_book",
          handler: () => {
            getHelpMenu()?.querySelector('a[data-i18n="menu.docs"]')?.click();
            return { keepOpen: true };
          }
        },
        {
          ...
          mdIcon: "start",
          handler: () => {
            getHelpMenu()?.querySelector('a[data-i18n="menu.getstart"]')?.click();
            return { keepOpen: true };
          }
        },
        {
          ...
          mdIcon: "widgets",
          handler: () => {
            getHelpMenu()?.querySelector('a[data-i18n="menu.features"]')?.click();
            return { keepOpen: true };
          }
        },
        {
          ...
          mdIcon: "tune",
          handler: () => {
            getHelpMenu()?.querySelector('a[data-i18n="menu.config"]')?.click();
            return { keepOpen: true };
          }
        },
        {
          ...
          handler: () => {
            getHelpMenu()?.querySelector('a[data-i18n="menu.sdk"]')?.click();
            return { keepOpen: true };
          }
        },
        {
          ...
          mdIcon: "newspaper",
          handler: () => {
            getHelpMenu()?.querySelector('a[data-i18n="menu.blog"]')?.click();
            return { keepOpen: true };
          }
        }
      ]
      ...
      children: [
        {
          ...
          mdIcon: "star",
          handler: () => {
            getHelpMenu()?.querySelector('a[data-i18n="menu.source"]')?.click();
            return { keepOpen: true };
          }
        },
        {
          ...
          mdIcon: "bug_report",
          handler: () => {
            getHelpMenu()?.querySelector('a[data-i18n="menu.report"]')?.click();
            return { keepOpen: true };
          }
        },
        {
          ...
          mdIcon: "receipt_long",
          handler: () => {
            getHelpMenu()?.querySelector('a[data-i18n="menu.license"]')?.click();
            return { keepOpen: true };
          }
        },
        {
  ...
  const keyboardShortcutsAction = {
    ...
    mdIcon: "keyboard",
    handler: () => {
      getKeyboardShortcutsMenuLink()?.click();
    }
  };
  const aboutAction = {
    id: "About",
  ...
  const changeMenuSetting = (setting, checked2) => {
    const toggle = [...getSettingToggles()].find((t) => t.dataset.config === setting);
    if (toggle) {
      toggle.checked = checked2;
      toggle.dispatchEvent(new Event("change"));
    }
  };
  const isActionList = (list) => Boolean(list?.every((a) => typeof a !== "string"));
  const traverseMenu = (data, transform) => data.map((action) => ({
    ...transform(action),
    children: isActionList(action.children) ? traverseMenu(action.children, transform) : action.children
  }));
  const transformAction = (action) => ({
    ...action,
    title: !action.children?.length ? action.title.replace(" \u2026", "").replace(" ...", "") : action.title.endsWith(" \u2026") || action.title.endsWith(" ...") ? action.title : action.title + " \u2026",
    hotkey: isMac() ? action.hotkey?.replace(/ctrl/g, "\u2318") : action.hotkey
  });
  const flatten = (list) => list.flatMap((a) => [a, ...isActionList(a.children) ? flatten(a.children) : []]);
  const getKeyboardShortcutList = (list) => flatten(list).filter((a) => a.hotkey != null);
...
var createProcessorItem = (processor) => {
...
function destroyAllSnackbars() {
  var instancesArray = [];
  Object.keys(instances).map(function(position) {
    return instances[position];
  }).forEach(function(positionInstances) {
    return instancesArray.push.apply(instancesArray, positionInstances);
  });
  return Promise.all(instancesArray.map(function(instance) {
...
// src/livecodes/notifications/snackbar.ts
var actionStyle = {
  minWidth: "2em",
  padding: "3px"
};
...
// src/livecodes/notifications/create-notifications.ts
var hasOpenNotifications = () => document.querySelectorAll(".snackbar").length > 0;
var createNotifications = () => {
  const timeout = 2e3;
  const getPosition = () => document.querySelector("dialog#modal")?.open ? "left" : "center";
  const createBar = (message, options) => {
  ...
  const info = (message, dismissable = true) => {
    createBar(message, {
      theme: infoTheme,
  ...
  const success = (message, dismissable = true) => {
    createBar("\u2713 " + message, {
      theme: successTheme,
      actions: dismissable ? [closeButton] : [],
      timeout
  ...
  const warning = (message, dismissable = true) => {
    createBar(message, {
  ...
  const error = (message, dismissable = true) => {
    createBar("\u2716 " + message, {
      position: getPosition(),
      theme: dangerTheme,
      actions: dismissable ? [closeButton] : [],
  ...
  const confirm = (message, confirmCallback, cancelCallback) => {
    const confirmAction = {
      ...acceptButton,
      callback(_button, snackbar) {
        confirmCallback();
    ...
    document.querySelector(".snackbar--button")?.focus();
  };
...
var createAccordion = ({
  ...
  const toggle = (title) => {
    ...
    if (!panel || !(panel instanceof HTMLElement) || !panel.classList.contains("panel"))
      return;
  ...
  accordions.forEach((accordion) => {
    ...
    titles.forEach((title) => {
      ...
      title.addEventListener("click", (ev) => {
        ...
        toggle(title);
        if ((single ?? accordion.classList.contains("single")) && title.classList.contains("active")) {
          titles.forEach((t) => {
            if (t !== title) {
...
var createModal = (deps) => {
  const overlay = document.querySelector("#overlay");
  const modalContainer = document.querySelector("#modal-container");
  const modal2 = document.querySelector("#modal");
  let isOpening;
  let onCloseFn = () => void 0;
  const show = (container, {
    size = "large",
    closeButton: closeButton2 = false,
    isAsync = false,
    onClose = () => void 0,
    scrollToSelector = "",
    autoFocus = !deps.isEmbed
  } = {}) => {
    modal2.className = size;
    modalContainer.innerHTML = "";
    modalContainer.appendChild(container);
    deps.translate(modal2);
    onCloseFn = onClose;
    ...
    setTimeout(() => {
      if (scrollToSelector) {
        const target = container.querySelector(scrollToSelector);
  ...
  function onClickOutside(ev) {
    const notificationsBar = modal2.querySelector(".snackbars-left");
    if (!modalContainer?.contains(ev.target) && !notificationsBar?.contains(ev.target) && !isOpening) {
      close();
    }
...
// src/livecodes/UI/theme-colors.ts
var themeColors = [
  { name: "blue", themeColor: "hsl(214, 40%, 50%)" },
  { name: "cyan", themeColor: "hsl(192, 40%, 50%)" },
  { name: "green", themeColor: "hsl(142, 40%, 50%)" },
  { name: "amber", themeColor: "hsl(38, 40%, 50%)" },
  { name: "red", themeColor: "hsl(0, 40%, 50%)" },
  { name: "violet", themeColor: "hsl(262, 40%, 50%)" },
  { name: "slate", themeColor: "hsl(220, 20%, 50%)" },
  { name: "custom", themeColor: void 0 }
];
...
var importProject = (url3) => {
  const id2 = url3.slice("id/".length);
  return shareService.getProject(id2);
};
...
var getConfigFromShareUrl = (text, isShareUrl = false) => {
  ...
  let projectId2 = [...text.matchAll(new RegExp(shareUrlPattern))].at(-1)?.[1];
  if (projectId2) {
    projectId2 = projectId2.replace(/]/g, "j");
    const alphabet = "23456789abcdefghijkmnpqrstuvwxyz";
    if (projectId2.slice("id/".length).split("").every((c2) => alphabet.includes(c2))) {
      return importProject(projectId2);
    }
  }
  if (isShareUrl) {
    try {
...
var cleanUpCode = async (code) => {
  ...
  const charactersFound = firstLine.slice(0, 6).split("").filter((c2) => buttonCharacters.includes(c2)).length;
...
var importFromFiles = async (files, populateConfig2, eventsManager2) => {
  const loadFiles = (files2) => new Promise((resolve, reject) => {
    ...
    for (const file of files2) {
      ...
      const reader = new FileReader();
      eventsManager2.addEventListener(reader, "load", (event) => {
      ...
      eventsManager2.addEventListener(reader, "error", () => {
        reject("Error: Failed to read file");
      });
      reader.readAsText(file);
    }
  });
  const loadZipFile = (files2) => importFromZip(files2[0], populateConfig2);
...
var populateConfig = (files, params2) => {
  if (files.length === 0)
    return {};
  ...
  const filesInParams = params2.files;
  if (filesInParams) {
...
// src/livecodes/toolspane/compiled-code-viewer.ts
var createCompiledCodeViewer = (config, baseUrl2, _editors, _eventsManager, isEmbed2, _runTests) => {
  let compiledCodeElement;
  let editor;
  let languageLabel;
  ...
  const fixTypes = (language, content) => {
    if (language === "javascript" && window.monaco && editor.monaco) {
      editor?.setValue(content + "\nexport {}");
      const monacoEditor = editor.monaco;
      const lineCount = monacoEditor.getModel()?.getLineCount() || 1;
      monacoEditor.setHiddenAreas([]);
      monacoEditor.setHiddenAreas([
        new window.monaco.Range(lineCount + 1, 0, lineCount + 2, 0)
      ]);
    }
  };
  const update = (language, content, label) => {
    if (!editor)
      return;
  ...
  const reloadEditor = async (newConfig) => {
    config = newConfig;
    if (!compiledCodeElement) {
      await load();
      return;
...
var createConsole = (config, baseUrl2, _editors, eventsManager2, isEmbed2, _runTests) => {
  let consoleEmulator;
  let editor;
  let consoleElement;
  ...
  const htmlToElement = (html6) => {
    const tag = html6.substr(1, 4);
    ...
    html6 = html6.trim();
    template.innerHTML = html6;
    return template.content.firstChild;
  };
  const convertTypes = (args) => args.map((arg) => {
    if (arg.type === "element") {
  ...
  const createConsoleEmulator = () => {
    if (consoleEmulator) {
      ...
      consoleEmulator = new Console(consoleElement);
      return consoleEmulator;
    }
    consoleEmulator = new Console(consoleElement, { theme: config.theme });
    eventsManager2.addEventListener(window, "message", (event) => {
      if (!consoleElement || event.origin !== sandboxService.getOrigin() || event.data.type !== "console") {
        return;
      }
      const message = event.data;
      const api = [
        "output",
        // to output messages from console input
        "log",
        "error",
        "info",
        "warn",
      ...
      if (api.includes(message.method)) {
        if (message.method === "clear") {
          ...
          consoleEmulator[message.method](...convertTypes(message.args));
        }
        updateMark();
      }
    });
  ...
  const createConsoleInput = async (force = false) => {
    if (editor && !force)
      return editor;
    const container = document.querySelector("#console-input");
    if (!container)
      throw new Error("Console input container not found");
    const editorOptions = {
      baseUrl: baseUrl2,
      container,
      language: "javascript",
    ...
    consoleEditor.addKeyBinding("exec", consoleEditor.keyCodes.Enter, () => {
      ...
      const iframe = document.querySelector(sourceSelector);
    ...
    consoleEditor.onContentChanged(() => {
      if (!consoleEditor.monaco)
        return;
      const height = consoleEditor.monaco.getContentHeight() < minHeight ? minHeight : consoleEditor.monaco.getContentHeight() * 2;
    ...
    const margin = document.querySelector("#console-input " + gutterSelector);
    if (margin) {
  ...
  const updateMark = () => {
    ...
    setTimeout(() => {
      const logCount = [
        ...document.querySelectorAll(".luna-console-log-content")
  ...
  return {
    ...
    getEditor: () => editor,
    reloadEditor,
    setTheme: (theme5) => exec(() => consoleEmulator?.setOption("theme", theme5)),
...
var run = '<i class="icon-run"></i>';
var checked = '<i class="icon-checked checked"></i>';
var unchecked = '<i class="icon-unchecked unchecked"></i>';
var reset = '<i class="icon-reset"></i>';
var edit = '<i class="icon-edit"></i>';

// src/livecodes/toolspane/test-viewer.ts
var createTestViewer = (_config, _baseUrl, _editors, eventsManager2, isEmbed2, runTests2) => {
  ...
  const createElements = () => {
    ...
    <a id="run-tests-btn" href="#" class="button" title="${window.deps.translateString("toolspane.test.run.desc", "Ctrl/\u2318 + Alt + T")}">
      ${run} ${window.deps.translateString("toolspane.test.run.heading", "Run")}
    </a>
    <a id="watch-tests-btn" href="#" class="button disabled" title="${window.deps.translateString("toolspane.test.watch.desc", "Run tests when code changes")}">
      ${checked} ${unchecked} ${window.deps.translateString("toolspane.test.watch.heading", "Watch")}
    </a>
    <a id="reset-tests-btn" href="#" class="button">${reset} ${window.deps.translateString("toolspane.test.reset", "Reset")}</a>
    ${isEmbed2 ? "" : '<a id="edit-tests-btn" href="#" class="button">' + edit + ` ${window.deps.translateString("toolspane.test.edit", "Edit")}</a>`}
    `;
    ...
    eventsManager2.addEventListener(
      document.querySelector("#reset-tests-btn"),
      "click",
      (ev) => {
        ev.preventDefault();
        resetTests();
  ...
  const resetTests = () => {
    testResultsElement.querySelectorAll(".test-result").forEach((item) => {
    ...
    const testSummary = testResultsElement.querySelector(".test-summary");
    if (testSummary) {
  ...
  const showResults = ({ results, error }) => {
    ...
    results.forEach((result) => {
      ...
      result.errors.map((err) => err.split("at Object.<anonymous>")[0]?.trim()).map((err) => err.split(`at ${sandboxService.getResultUrl()}`)[0]?.trim()).map(
        (err) => err.startsWith("AssertionError: ") ? err.replace("AssertionError: ", "") : err
      ).forEach((err) => {
    ...
    const skipped = results.filter((r2) => r2.status === "skip").length;
    const total = results.length;
    const duration = results.reduce((totalDuration, r2) => totalDuration + r2.duration, 0) / 1e3;
    ...
    summary.innerHTML = window.deps.translateString(
      ...
      {
        isHTML: true,
        failed: failed !== 0 ? `<span class="fail">${window.deps.translateString("toolspane.test.summary.failed", "{{failedNum}} failed", { failedNum: failed })}</span>,` : "",
        passed: passed !== 0 ? `<span class="pass"> ${window.deps.translateString("toolspane.test.summary.passed", "{{passedNum}} passed", { passedNum: passed })}</span>,` : "",
        skipped: skipped !== 0 ? `<span class="skip"> ${window.deps.translateString("toolspane.test.summary.skipped", "{{skippedNum}} skipped", { skippedNum: skipped })}</span>,` : "",
...
// src/livecodes/toolspane/tools.ts
var createToolsPane = (config, baseUrl2, editors2, eventsManager2, isEmbed2, runTests2, setTools) => {
  let toolsSplit;
  let status;
  let activeToolId = 0;
  const fullList = [
  ...
  const isEnabled = (tool) => config.tools.enabled === "all" || config.tools.enabled?.includes(tool.name) === true;
  const toolList = fullList.filter(isEnabled);
  const populateTools = (config2, baseUrl3, editors3, eventsManager3, isEmbed3, runTests3) => toolList.map(
    (tool) => tool.factory(config2, baseUrl3, editors3, eventsManager3, isEmbed3, runTests3)
  );
  const allTools = populateTools(config, baseUrl2, editors2, eventsManager2, isEmbed2, runTests2);
  const tools = [...allTools];
  const result = getResultElement();
  const getGutterSize2 = () => {
  ...
  const sizeChanged = () => {
    ...
    status = status === "none" ? "none" : toolsSplit.getSizes()[0] > 90 ? "closed" : toolsSplit.getSizes()[0] < 10 ? "full" : "open";
    updateConfig2();
  };
  const open = (toolId, maximize = false) => {
    if (maximize) {
  ...
  const createToolsSplit = () => {
    ...
    toolsSplit = split_es_default(["#result", "#tools-pane"], {
      sizes: sizes.closed,
      minSize: [0, 0],
      gutterSize,
      direction: "vertical",
      elementStyle: (_dimension, size, _gutterSize) => ({
        height: size < 15 ? "0" : size > 85 ? `calc(100% - ${gutterSize}px)` : `calc(${size}% - ${gutterSize}px / 2)`
      }),
    ...
    const toolsPaneBar = document.querySelector("#output .gutter");
    ...
    eventsManager2.addEventListener(
      ...
      "resize",
      () => {
        const toolsPane2 = document.querySelector("#tools-pane");
        if (!toolsPane2)
          return;
        if (toolsSplit.getSizes()[0] < 10) {
          result.style.height = "0";
          toolsPane2.style.height = `calc(100% - ${gutterSize}px)`;
        } else if (toolsSplit.getSizes()[0] > 90) {
          result.style.height = `calc(100% - ${gutterSize}px)`;
          toolsPane2.style.height = "0";
        }
        sizeChanged();
      },
      false
    ...
    closeButton2.classList.add("console-close-button");
    closeButton2.title = window.deps.translateString("toolspane.close", "Close");
    const iconCSS = '<i class="icon-close"></i>';
    closeButton2.innerHTML = iconCSS;
    eventsManager2.addEventListener(
      closeButton2,
      "click",
      () => {
    ...
    buttons.appendChild(closeButton2);
    return toolsSplit;
  };
  const resize = (newStatus) => {
    if (newStatus === "none") {
      setHidden(true);
    } else {
      setHidden(false);
  ...
  const load = async () => {
    const initialLoad = status === void 0;
  ...
  const observeStyleChange = () => {
    const styleObserver = new MutationObserver(() => {
      const newGutterSize = getGutterSize2();
  ...
  const getToolId = (name) => {
    const id2 = tools.findIndex((t) => t?.name === name);
    return id2 > -1 ? id2 : 0;
  };
  const disableTool = (name) => {
    ...
    const domTitle = document.querySelector("#tools-pane-titles ." + name);
    if (domTitle) {
  ...
  const enableTool = (name) => {
    const id2 = allTools.findIndex((t) => t.name === name);
    if (id2 === -1)
      return;
    ...
    api[name] = allTools[id2];
    tools[id2] = allTools[id2];
    const toolTitle = document.querySelector(".tools-pane-title." + name);
    if (toolTitle) {
  ...
  const api = {
    ...
    setActiveTool: (title) => setActiveTool(getToolId(title)),
    disableTool,
    enableTool,
...
var createTypeLoader = (baseUrl2) => {
  let loadedTypes = {};
  const libs = [];
  const getTypeContents = async (type2, callback) => {
    let content = "";
    const name = Object.keys(type2)[0];
    const value = Object.values(type2)[0];
    const url3 = typeof value === "string" ? value : value.url;
    if (loadedTypes[name]) {
    ...
    if (url3) {
      try {
        ...
        if (!res.ok)
          throw new Error("Failed fetching: " + url3);
        let dts = await res.text();
        if (hasUrlImportsOrExports(dts)) {
          const dtsBundleModule = await import(baseUrl2 + "bundle-types.js");
          dts = await dtsBundleModule.bundle({ name, main: url3 });
        }
        const declareAsModule = typeof value !== "string" && value.declareAsModule === false ? false : !dts.includes("declare module") || typeof value !== "string" && value.declareAsModule === true;
    ...
    const prevTypes = Object.keys(loadedTypes).filter((k) => loadedTypes[k] !== "").reduce(
      (acc, k) => ({
        ...acc,
        [k]: loadedTypes[k]
      }),
  ...
  const getTypesFromAta = async (code, callback) => {
    if (!code?.trim()) {
      return [];
    }
    const types = await window.compiler?.typescriptFeatures?.({
      feature: "ata",
      payload: code
    }) ?? [];
    libs.push(...types);
  ...
  const loadTypes = async (types, callback) => {
  ...
  const load = async (code, configTypes, loadAll = false, forceLoad = false, callback) => {
    const imports = getImports(code);
    const codeTypes = imports.reduce((accTypes, lib) => {
      let currentType;
      const loaded = Object.keys(loadedTypes).find((t) => lib === t) || Object.keys(loadedTypes).find((t) => lib.startsWith(t + "/")) && !Object.keys(configTypes).find((t) => lib === t);
      const fromConfig = Object.keys(configTypes).find((t) => lib === t) || Object.keys(configTypes).find((t) => lib.startsWith(t + "/"));
      if (loaded && !forceLoad) {
        currentType = {};
      } else if (fromConfig) {
    ...
    const autoloadTypes = objectFilter(
      configTypes,
      (value, key) => (!Object.keys(loadedTypes).includes(key) || forceLoad) && typeof value !== "string" && value.autoload === true
    );
...
var showMode = (mode, view) => {
  ...
  const editorContainerElement = getEditorContainerElement();
  const editorsElement = getEditorsElement();
  ...
  const resultButton = getResultButton();
  const editorTools = getEditorToolbar();
  const showToolbar = modeConfig[0] === "1";
  const showEditor2 = modeConfig[1] === "1";
...
var login = async () => new Promise((resolve, reject) => {
  const loginHandler = (scopes) => {
    if (!authService) {
      reject(window.deps.translateString("core.error.login", "Login error!"));
    } else {
      authService.signIn(scopes).then((user) => {
        if (!user) {
          reject(window.deps.translateString("core.error.login", "Login error!"));
        } else {
          manageStoredUserData(user, "restore");
          const displayName = user.displayName || user.username;
          const loginSuccessMessage = displayName ? window.deps.translateString(
...
var setUserData = async (data) => {
  const user = await authService?.getUser();
  if (!user || !stores2.userData)
    return null;
  const id2 = user.username || user.uid;
  const oldData = (await stores2.userData.getItem(id2))?.data;
  const key = await stores2.userData?.updateItem(id2, {
    id: id2,
    data: {
      ...oldData,
      ...data
...
var manageStoredUserData = async (user, action) => {
  const storeKeys = Object.keys(stores2).filter(
    (k) => !["recover", "sync"].includes(k)
  );
  const syncModule = await import(baseUrl + "sync.js");
  syncModule.init(baseUrl);
  for (const storeKey of storeKeys) {
    if (action === "clear") {
      await syncModule.exportToLocalSync({ user, storeKey });
      stores2[storeKey]?.clear();
    } else {
...
var registerScreen = (screen, fn) => {
  const registered = screens.find((s) => s.screen.toLowerCase() === screen.toLowerCase());
  if (registered) {
    registered.show = fn;
  } else {
    screens.push({ screen: screen.toLowerCase(), show: fn });
  }
};
...
var setLayout = (layout) => {
  ...
  const newLayout = layout ?? (window.innerWidth < 768 && window.innerHeight > window.innerWidth ? "vertical" : "horizontal");
  split?.setLayout(newLayout);
  const layoutToggle = getLayoutToggle();
  if (layoutToggle) {
    const layoutSwitch = layoutToggle.closest(".switch");
    if (layout === void 0) {
      ...
      layoutSwitch.title = layout === "vertical" ? window.deps.translateString("core.layout.vertical", "Vertical layout") : window.deps.translateString("core.layout.horizontal", "Horizontal layout");
    }
  }
  handleIframeResize();
};
var changeAndSaveLayout = (layout) => {
...
var setBroadcastStatus = (info) => {
  ...
  const broadcastStatusBtn = getBroadcastStatusBtn();
  if (!broadcastStatusBtn)
    return;
...
var handleTitleEdit = () => {
  ...
  eventsManager.addEventListener(projectTitle, "keypress", blurOnEnter, false);
...
var handleIframeResize = () => {
  const gutter = getGutterElement();
  if (!gutter)
    return;
  ...
  eventsManager.addEventListener(window, "message", (event) => {
    const iframe = getResultIFrameElement();
    if (!sizeLabel || !iframe || event.source !== iframe.contentWindow || event.data.type !== "resize") {
      return;
    }
...
var handleSelectEditor = () => {
  getEditorTitles().forEach((title) => {
    eventsManager.addEventListener(
      title,
      "click",
      (ev) => {
        ev.preventDefault();
        showEditor(title.dataset.editor);
        setAppData({ language: getEditorLanguage(title.dataset.editor) });
        setProjectRecover();
      },
      false
    );
...
var handleChangeLanguage = () => {
  if (getConfig().allowLangChange) {
    getLanguageMenuLinks().forEach((menuItem) => {
      eventsManager.addEventListener(
        menuItem,
        "click",
        async () => {
          menuItem.closest(".menu-scroller")?.classList.add("hidden");
          await changeLanguage(menuItem.dataset.lang);
          setAppData({ language: menuItem.dataset.lang });
        },
        false
      );
    });
  } else {
    getLanguageMenuButtons().forEach((menuButton) => {
...
var handleKeyboardShortcuts = () => {
  ...
  const hotKeys = async (e) => {
    ...
    if (e.code === "Escape") {
      ...
      if (lastkeys === "Esc") {
        e.preventDefault();
        if ((toolsPane?.getStatus() === "open" || toolsPane?.getStatus() === "full") && toolsPane.getActiveTool() === "console") {
          getConsoleButton()?.focus();
        } else {
          getFocusButton()?.focus();
        }
        lastkeys = "Esc + Esc";
        return;
      }
    ...
    const editorIds2 = ["markup", "style", "script"].filter(
      (id2) => getConfig()[id2].hideTitle !== true
    );
    if (ctrl(e) && e.altKey && ["1", "2", "3", "ArrowLeft", "ArrowRight"].includes(e.key)) {
      e.preventDefault();
      split?.show("code");
      const index = ["1", "2", "3"].includes(e.key) ? Number(e.key) - 1 : e.key === "ArrowLeft" ? editorIds2.findIndex((id2) => id2 === getConfig().activeEditor) - 1 || 0 : e.key === "ArrowRight" ? editorIds2.findIndex((id2) => id2 === getConfig().activeEditor) + 1 || 0 : 0;
      const editorIndex = index === editorIds2.length ? 0 : index === -1 ? editorIds2.length - 1 : index;
      showEditor(editorIds2[editorIndex]);
...
var handleKeyboardShortcutsScreen = () => {
  if (isEmbed)
    return;
  ...
  const createShortcutsUI = async () => {
    ...
    const shortcutsContainer = div.firstChild;
    const rows = keyboardShortcuts.map(
      (item) => `
      <tr>
        <td>${item.title}</td>
        <td>${item.hotkey?.split("+").map((key) => `<kbd>${capitalize(key)}</kbd>`).join(" ")}</td>
      </tr>
    `
    ).join("");
    shortcutsContainer.querySelector("tbody").innerHTML = rows;
    modal.show(shortcutsContainer);
  };
  eventsManager.addEventListener(
    getKeyboardShortcutsMenuLink(),
    "click",
    createShortcutsUI,
    false
  );
...
var handleCommandMenu = async () => {
  ...
  if (footer) {
    footer.innerHTML = footer.innerHTML.replace("to select", window.deps.translateString("commandMenu.toSelect", "to select")).replace("to navigate", window.deps.translateString("commandMenu.toNavigate", "to navigate")).replace("to close", window.deps.translateString("commandMenu.toClose", "to close")).replace(
      "move to parent",
  ...
  const openCommandMenu = () => {
    modal.close();
    ninja.close();
    getAppMenuHelpScroller()?.classList.add("hidden");
  ...
  eventsManager.addEventListener(getCommandMenuLink(), "click", () => openCommandMenu(), true);
};
var handleLogoLink = () => {
  if (isEmbed || getConfig().mode === "result")
    return;
  const logoLink = getLogoLink();
  eventsManager.addEventListener(logoLink, "click", async (event) => {
    event.preventDefault();
...
var handleRunButton = () => {
  ...
  eventsManager.addEventListener(getRunButton(), "click", handleRun);
};
var handleResultButton = () => {
  eventsManager.addEventListener(getResultButton(), "click", () => split?.show("toggle", true));
};
var handleShareButton = () => {
  eventsManager.addEventListener(getShareButton(), "click", () => showScreen("share"));
};
var handleI18nMenu = () => {
  const menuContainer = getI18nMenuContainer();
  ...
  Object.entries(appLanguages).forEach(([langCode, langLabel]) => {
    ...
    eventsManager.addEventListener(link, "click", (ev) => {
      ev.preventDefault();
      if (langCode === getConfig().appLanguage)
        return;
      setUserConfig({ appLanguage: langCode });
  ...
  contributeLink.href = "https://github.com/live-codes/livecodes/blob/develop/docs/docs/contribution/i18n.mdx";
  ...
  docsLink.href = `${"http://localhost:3000/docs/"}features/i18n`;
  ...
  registerMenuButton(menuContainer, getI18nMenuButton());
};
var handleEditorTools = () => {
  if (!configureEditorTools(getActiveEditor().getLanguage()))
    return;
  const originalMode = getConfig().mode;
  eventsManager.addEventListener(getFocusButton(), "click", () => {
    const config = getConfig();
    ...
    const consoleIsEnabled = config.tools.enabled?.includes("console") || config.tools.enabled === "all" || config.tools.enabled == null;
    if (newMode === "focus" && consoleIsEnabled) {
      toolsPane?.setActiveTool("console");
    }
    window.deps?.showMode?.(newMode, config.view);
  });
  eventsManager.addEventListener(getCopyButton(), "click", () => {
  ...
  eventsManager.addEventListener(getUndoButton(), "click", () => {
    const activeEditor = getActiveEditor();
    activeEditor.undo();
    activeEditor.focus();
  });
  eventsManager.addEventListener(getRedoButton(), "click", () => {
    const activeEditor = getActiveEditor();
    activeEditor.redo();
    activeEditor.focus();
  });
  eventsManager.addEventListener(getFormatButton(), "click", async () => {
    await format(false);
  });
  eventsManager.addEventListener(getCopyAsUrlButton(), "click", () => {
  ...
  eventsManager.addEventListener(getCodeToImageButton(), "click", () => {
    showScreen("code-to-image");
  });
  eventsManager.addEventListener(getEditorStatus(), "click", () => {
    showScreen("editor-settings", { scrollToSelector: 'label[data-name="editorMode"]' });
  });
  eventsManager.addEventListener(getExternalResourcesBtn(), "click", () => {
    showScreen("resources");
  });
  eventsManager.addEventListener(getProjectInfoBtn(), "click", () => {
    showScreen("info");
  });
  eventsManager.addEventListener(getCustomSettingsBtn(), "click", () => {
    showScreen("custom-settings");
  });
  eventsManager.addEventListener(getEditorSettingsBtn(), "click", () => {
    showScreen("editor-settings");
  });
};
var handleProcessors = () => {
  const styleMenu = getstyleMenu();
  const processorList = processors.filter((p) => processorIsEnabled(p.name, getConfig())).filter((p) => !p.hidden).map((p) => ({ name: p.name, title: p.title }));
  ...
  processorList.forEach((processor) => {
    ...
    eventsManager.addEventListener(
      processorItem.firstElementChild,
      "click",
      async (event) => {
        event.preventDefault();
        const toggle = processorItem.querySelector("input");
        if (!toggle)
          return;
        toggle.checked = !toggle.checked;
        const processorName = toggle.dataset.processor;
        if (!processorName || !processorList.find((p) => p.name === processorName))
          return;
        setConfig({
          ...getConfig(),
          processors: [
            ...toggle.checked ? [...getConfig().processors, processorName] : getConfig().processors.filter((p) => p !== processorName)
          ]
        });
...
var handleAppMenuProject = () => {
  const menuProjectContainer = getAppMenuProjectScroller();
  const menuProjectButton = getAppMenuProjectButton();
  if (!menuProjectContainer || !menuProjectButton)
    return;
  const html6 = isMac() ? menuProjectHTML.replace(/<kbd>Ctrl<\/kbd>/g, "<kbd>\u2318</kbd>") : menuProjectHTML;
  menuProjectContainer.innerHTML = html6;
  translateElement(menuProjectContainer);
  registerMenuButton(menuProjectContainer, menuProjectButton);
};
var handleAppMenuSettings = () => {
  const menuSettingsContainer = getAppMenuSettingsScroller();
  const menuSettingsButton = getAppMenuSettingsButton();
  if (!menuSettingsContainer || !menuSettingsButton)
    return;
  const html6 = isMac() ? menuSettingsHTML.replace(/<kbd>Ctrl<\/kbd>/g, "<kbd>\u2318</kbd>") : menuSettingsHTML;
  menuSettingsContainer.innerHTML = html6;
...
var handleAppMenuHelp = () => {
  const menuHelpContainer = getAppMenuHelpScroller();
  const menuHelpButton = getAppMenuHelpButton();
  if (!menuHelpContainer || !menuHelpButton)
    return;
  const html6 = isMac() ? menuHelpHTML.replace(/<kbd>Ctrl<\/kbd>/g, "<kbd>\u2318</kbd>") : menuHelpHTML;
  menuHelpContainer.innerHTML = html6;
...
var adjustFontSize = (container) => {
  if (!i18n || i18n.getLanguage() === "en")
    return;
  const adjustFont = (el) => new Promise((resolve) => {
    const fontSize = Number(getComputedStyle(el).getPropertyValue("font-size").replace("px", ""));
    const maxWidth = Number(getComputedStyle(el).getPropertyValue("--label-max-width").replace("px", "")) || 188;
    if (el.clientWidth <= maxWidth || fontSize <= 0)
      return resolve();
  ...
  setTimeout(startAdjustment, 1e3);
  setTimeout(startAdjustment, 2e3);
  setTimeout(startAdjustment, 3e3);
};
var handleAppMenuButtonFocus = () => {
...
var handleSettings = () => {
  ...
  toggles.forEach((toggle) => {
    eventsManager.addEventListener(toggle, "change", async () => {
      ...
      if (!configKey || !(configKey in getConfig()) && configKey !== "autosync")
        return;
      if (configKey === "theme") {
        ...
        const newLayout = toggle.readOnly ? "vertical" : !toggle.checked ? "horizontal" : void 0;
        setConfig({
          ...getConfig(),
          layout: newLayout
        });
  ...
  eventsManager.addEventListener(delayRange, "input", () => {
    ...
    delayValue.textContent = String(value / 1e3);
    setConfig({ ...getConfig(), delay: value });
    setUserConfig(getUserConfig(getConfig()));
  });
  const themeColorSelector = getThemeColorSelector();
...
var handleLogin = () => {
  eventsManager.addEventListener(getLoginLink(), "click", login, false);
  registerScreen("login", login);
};
var handleLogout = () => {
  eventsManager.addEventListener(getLogoutLink(), "click", logout, false);
};
var handleNew = () => {
  const templatesContainer = createTemplatesContainer(eventsManager, () => loadUserTemplates());
  const userTemplatesScreen = getUserTemplatesScreen(templatesContainer);
  const loadUserTemplates = async () => {
    const defaultTemplate = getAppData()?.defaultTemplate;
    const userTemplates = (await stores2.templates?.getList() || []).sort(
      (a, b) => a.id === defaultTemplate ? -1 : b.id === defaultTemplate ? 1 : 0
    );
    ...
    userTemplates.forEach((item) => {
      ...
      eventsManager.addEventListener(
        ...
        async (event) => {
          ...
          const template = (await stores2.templates?.getItem(itemId))?.config;
          if (template) {
            await loadConfig({
              ...template,
      ...
      eventsManager.addEventListener(
        ...
        async () => {
          notifications.confirm(
            ...
            async () => {
              if (!stores2.templates)
                return;
              if (getAppData()?.defaultTemplate === item.id) {
                setAppData({ defaultTemplate: null });
              }
              await stores2.templates.deleteItem(item.id);
              const li = deleteButton.parentElement;
              li.classList.add("hidden");
              setTimeout(async () => {
                li.style.display = "none";
                if (stores2.templates && (await stores2.templates.getList()).length === 0) {
                  list.remove();
                  userTemplatesScreen.innerHTML = noUserTemplates();
                }
              }, 500);
  ...
  let starterTemplatesCache;
  const createTemplatesUI = async () => {
    const starterTemplatesList = getStarterTemplatesList(templatesContainer);
    const loadingText = starterTemplatesList?.firstElementChild;
    if (!starterTemplatesCache) {
      getTemplates().then((starterTemplates2) => {
        starterTemplatesCache = starterTemplates2;
        loadingText?.remove();
        starterTemplates2.forEach((template) => {
    ...
    setTimeout(() => getStarterTemplatesTab(templatesContainer)?.click());
...
var handleSave = () => {
  eventsManager.addEventListener(getSaveLink(), "click", async (event) => {
    event.preventDefault();
    await save(true);
  });
};
var handleFork = () => {
  eventsManager.addEventListener(getForkLink(), "click", async (event) => {
    event.preventDefault();
    await fork();
  });
};
var handleSaveAsTemplate = () => {
  eventsManager.addEventListener(getSaveAsTemplateLink(), "click", async (event) => {
    event.preventDefault();
    if (stores2.templates) {
      await stores2.templates.addItem(getConfig());
      notifications.success(
...
var handleOpen = () => {
  const createList = async () => {
    modal.show(loadingMessage(), { size: "small" });
    const openModule = await import(baseUrl + "open.js");
    await openModule.createSavedProjectsList({
      ...
      modal,
      notifications,
      projectStorage: stores2.projects || fakeStorage,
      setProjectId: (id2) => projectId = id2,
      showScreen,
      languages,
      getLanguageTitle,
      getLanguageByAlias
...
var handleImport = () => {
  const createImportUI = async () => {
    ...
    importModule.createImportUI({
      ...
      loadConfig,
      populateConfig,
      projectStorage: stores2.projects,
      showScreen
    });
  };
  eventsManager.addEventListener(
...
var handleExport = () => {
  ...
  const loadModule = async () => {
    exportModule = exportModule || await import(baseUrl + "export.js");
  };
  eventsManager.addEventListener(
    getExportJSONLink(),
    "click",
  ...
  eventsManager.addEventListener(
    ...
    async (event) => {
      event.preventDefault();
      updateConfig();
      const html6 = await getResultPage({ forExport: true });
      await loadModule();
  ...
  eventsManager.addEventListener(
    ...
    async () => {
      ...
      const cache2 = getCachedCode();
      const compiled = {
        markup: cache2.markup.compiled,
        style: cache2.style.compiled,
        script: cache2.script.compiled
      };
      await loadModule();
...
var handleShare = () => {
  const createShareUI = async () => {
    modal.show(loadingMessage(), { size: "small" });
    const importModule = await import(baseUrl + "share.js");
    const shareFn = (shortUrl = false, permanentUrl = false) => share(
      shortUrl,
      /* contentOnly= */
      true,
      /* urlUpdate= */
...
var handleDeploy = () => {
  const createDeployUI = async () => {
    ...
    const setProjectDeployRepo = async (repo) => {
      if (!projectId)
        return;
      await setUserData({
        deploys: {
    ...
    const deployModule = await import(baseUrl + "deploy.js");
  ...
  eventsManager.addEventListener(getDeployLink(), "click", createDeployUI, false);
...
var handleSync = () => {
  ...
  eventsManager.addEventListener(getSyncLink(), "click", createSyncUI, false);
  registerScreen("sync", createSyncUI);
};
var handleAutosync = async () => {
  if (isEmbed)
    return;
  const minute = 1e3 * 60;
  ...
  const sync = async () => {
    ...
    if (!syncData?.autosync)
      return;
    if (Date.now() - syncData.lastSync < syncFrequency)
      return;
    const user = await authService?.getUser();
...
var handlePersistentStorage = async () => {
  if (isEmbed)
    return;
  ...
  const updateRecentProjects = (allProjects) => {
    const recentProjects = allProjects?.slice(0, 5).map((p) => ({ id: p.id, title: p.config.title, description: p.config.description })) || [];
    setAppData({ recentProjects });
  };
  const projectSubscription = stores2.projects?.subscribe(requestPersistence);
  const templateSubscription = stores2.templates?.subscribe(requestPersistence);
  const assetSubscription = stores2.assets?.subscribe(requestPersistence);
  stores2.projects?.subscribe(updateRecentProjects);
};
var handleBackup = () => {
  const createBackupUI = async () => {
    modal.show(loadingMessage(), { size: "small" });
    const backupModule = await import(baseUrl + "backup.js");
  ...
  eventsManager.addEventListener(getBackupLink(), "click", createBackupUI, false);
...
var handleBroadcast = () => {
  ...
  const createBroadcastUI = async () => {
    modal.show(loadingMessage(), { size: "small" });
    const syncUIModule = await import(baseUrl + "broadcast.js");
  ...
  eventsManager.addEventListener(getBroadcastLink(), "click", createBroadcastUI, false);
...
var handleWelcome = () => {
  ...
  const createWelcomeUI = async () => {
    ...
    const welcomeContainer = div.firstChild;
    modal.show(welcomeContainer);
    const showWelcomeCheckbox = getModalShowWelcomeCheckbox(welcomeContainer);
    showWelcomeCheckbox.checked = getConfig().welcome;
    eventsManager.addEventListener(getWelcomeLinkNew(welcomeContainer), "click", () => {
      showScreen("new");
    });
    eventsManager.addEventListener(getWelcomeLinkOpen(welcomeContainer), "click", () => {
      showScreen("open");
    });
    eventsManager.addEventListener(getWelcomeLinkImport(welcomeContainer), "click", () => {
      showScreen("import");
    });
    eventsManager.addEventListener(getWelcomeLinkRecentOpen(welcomeContainer), "click", () => {
      showScreen("open");
    });
    eventsManager.addEventListener(getWelcomeLinkTemplates(welcomeContainer), "click", () => {
      showScreen("new");
    });
    ...
    const loadRecentProject = async (pId) => {
      modal.show(loadingMessage(), { size: "small" });
      const savedProject = (await stores2.projects?.getItem(pId))?.config;
      if (savedProject) {
    ...
    const welcomeModalScreen = getModalWelcomeScreen(welcomeContainer);
    const welcomeRecent = getModalWelcomeRecent(welcomeContainer);
    if (recentProjects.length === 0 && welcomeModalScreen && welcomeRecent) {
      ...
      const list = getModalWelcomeRecentList(welcomeContainer);
    ...
    if (!defaultTemplateId) {
      getWelcomeLinkNoDefaultTemplate(welcomeContainer).style.display = "inline-block";
    } else {
      const loadTemplateLink = getWelcomeLinkLoadDefault(welcomeContainer);
      eventsManager.addEventListener(
        loadTemplateLink,
        "click",
        async (event) => {
    ...
    getWelcomeLinkDefaultTemplateLi(welcomeContainer).style.visibility = "visible";
    ...
    const recentTemplates = [
      ...
      ...defaultTemplates.filter((t) => !savedRecentTemplates.map((r2) => r2.name).includes(t.name))
    ].slice(0, 5).reverse();
    const templateList = getModalWelcomeTemplateList(welcomeContainer);
  ...
  eventsManager.addEventListener(getWelcomeLink(), "click", createWelcomeUI);
...
var handleAbout = () => {
  ...
  const createAboutUI = async () => {
    ...
    const repoUrl = "https://github.com/live-codes/livecodes";
    const div = document.createElement("div");
    div.innerHTML = aboutScreen.replace(/{{COMMIT_URL}}/g, `${repoUrl}/commit/${versions.commitSHA}`).replace(/{{APP_URL}}/g, versions.appUrl).replace(/{{SDK_URL}}/g, versions.sdkUrl).replace(
      "livecodes-text-logo-nowrap.svg",
      () => getConfig().theme === "dark" ? "livecodes-text-logo-nowrap-light.svg" : "livecodes-text-logo-nowrap.svg"
    );
    const aboutContainer = div.firstChild;
    modal.show(aboutContainer);
  };
  eventsManager.addEventListener(getAboutLink(), "click", createAboutUI);
  registerScreen("about", createAboutUI);
};
var handleProjectInfo = () => {
  const onUpdate = async (title, description, head, htmlAttrs, tags) => {
    let attrs = "";
    try {
  ...
  const createProjectInfo = () => createProjectInfoUI(getConfig(), stores2.projects || fakeStorage, modal, onUpdate);
  eventsManager.addEventListener(getProjectInfoLink(), "click", createProjectInfo, false);
  registerScreen("info", createProjectInfo);
};
var handleEmbed = () => {
  const getUrlFn = async (permanentUrl = false) => (await share(
    /* shortUrl= */
    true,
    /* contentOnly= */
    true,
  ...
  const config = getConfig();
  const createEditorFn = async (container) => createEditor({
    baseUrl,
    container,
    editorId: "embed",
    getLanguageExtension,
  ...
  const createEmbedUI = async () => {
    modal.show(loadingMessage(), { size: "small" });
    const embedModule = await import(baseUrl + "embed-ui.js");
  ...
  eventsManager.addEventListener(getEmbedLink(), "click", createEmbedUI, false);
  registerScreen("embed", createEmbedUI);
};
var changeEditorSettings = (newConfig) => {
  if (!newConfig)
    return;
...
var handleEditorSettings = () => {
  const createEditorSettingsUI = async ({
    scrollToSelector = ""
  } = {}) => {
    modal.show(loadingMessage(), { size: "small" });
    const editorSettingsModule = await import(baseUrl + "editor-settings.js");
    await editorSettingsModule.createEditorSettingsUI({
      ...
      deps: {
        ...
        createEditor,
        loadTypes: async (code) => typeLoader.load(code, {}),
...
var handleCodeToImage = () => {
  ...
  const createCodeToImageUI = async () => {
    ...
    const activeEditor = getActiveEditor();
    const createPreviewEditor = (options) => createEditor({
    ...
    const currentUrl = (location.origin + location.pathname).split("/").slice(0, -1).join("/");
    const getShareUrl = async (config, shortUrl = true) => {
      if (shortUrl) {
    ...
    const codeToImageModule = await import(baseUrl + "code-to-image.js");
    const title = getConfig().title;
...
var handleAssets = () => {
  ...
  const createList = async () => {
    ...
    await assetsModule.createAssetsList({
      ...
      modal,
      notifications,
      assetsStorage: stores2.assets || fakeStorage,
      showScreen,
      baseUrl
    });
  };
  const createAddAsset = async (activeTab) => {
    await loadModule();
    const deployModule = await import(baseUrl + "deploy.js");
    const deployAsset = async (user, file) => deployModule.deployFile({
      file,
      user,
  ...
  eventsManager.addEventListener(getAssetsLink(), "click", createList, false);
  registerScreen("assets", createList);
  registerScreen("add-asset", (tab) => {
...
var handleSnippets = () => {
  ...
  const loadModule = async () => {
    modal.show(loadingMessage(), { size: "small" });
    snippetsModule = snippetsModule || await import(baseUrl + "snippets.js");
  };
  const createEditorFn = async (options) => createEditor({
    baseUrl,
    container: null,
    editorId: "snippet",
    getLanguageExtension,
  ...
  const createList = async () => {
    ...
    await snippetsModule.createSnippetsList({
      ...
      modal,
      notifications,
      snippetsStorage: stores2.snippets || fakeStorage,
      deps: { createEditorFn, showScreen }
    });
  };
  const createAddSnippet = async (snippetId) => {
    await loadModule();
  ...
  eventsManager.addEventListener(getSnippetsLink(), "click", createList, false);
  registerScreen("snippets", createList);
  registerScreen("add-snippet", (snippetId) => {
    setTimeout(() => createAddSnippet(snippetId));
  });
};
var handleExternalResources = () => {
  const createExrenalResourcesUI = async () => {
    ...
    modal.show(loadingMessage(), { size: "small", autoFocus: false });
    const resourcesModule = await import(baseUrl + "resources.js");
...
var handleCustomSettings = () => {
  const createCustomSettingsUI = async () => {
    const config = getConfig();
    let customSettingsEditor;
    const div = document.createElement("div");
    div.innerHTML = customSettingsScreen;
    const customSettingsContainer = div.firstChild;
    ...
    const options = {
      ...
      container: getCustomSettingsEditor(),
      language: "json",
    ...
    eventsManager.addEventListener(getLoadCustomSettingsButton(), "click", async () => {
      let customSettings = {};
  ...
  eventsManager.addEventListener(
    ...
    (ev) => {
      ...
      if (getConfig().autotest) {
        ...
        getWatchTestsButton()?.classList.add("disabled");
      }
    },
    false
  );
};
var handleTestEditor = () => {
  const createTestEditorUI = async () => {
    const config = getConfig();
    let testEditor;
    const div = document.createElement("div");
    div.innerHTML = testEditorScreen;
    const testEditorContainer = div.firstChild;
    modal.show(testEditorContainer, { onClose: () => testEditor?.destroy() });
    const testLanguage = config.tests?.language || "tsx";
    const editorLanguage = "jsx";
    const options = {
      baseUrl,
      mode: config.mode,
      readonly: config.readonly,
      editorId: "tests",
      container: getTestEditor(),
    ...
    eventsManager.addEventListener(getLoadTestsButton(), "click", async () => {
...
var handleResultLoading = () => {
  ...
  const showResultModeDrawer = (event) => {
    const iframe = getResultIFrameElement();
    if (!iframe || event.source !== iframe.contentWindow || event.data.type !== "loading" || event.data.payload !== false || getConfig().mode !== "result") {
      return;
    }
...
var handleResultPopup = () => {
  ...
  popupBtn.style.pointerEvents = "all";
  ...
  const openWindow = async () => {
    ...
    url3 = url3 || URL.createObjectURL(new Blob([resultPopupHTML], { type: "text/html" }));
    const notice = "#---TEMPORARY-URL---";
    resultPopup = window.open(url3 + notice, "livecodes-result", `width=800,height=400`);
    eventsManager.addEventListener(window, "message", async (ev) => {
      if (ev.source !== resultPopup)
        return;
  ...
  getToolspaneTitles()?.appendChild(popupBtn);
};
var handleResultZoom = () => {
  ...
  zoomBtn.style.pointerEvents = "all";
  zoomBtn.innerHTML = `
  <button class="text">
  ...
  getToolspaneTitles()?.appendChild(zoomBtn);
};
var handleBroadcastStatus = () => {
  ...
  broadcastStatusBtn.title = window.deps.translateString("core.broadcast.heading", "Broadcast");
  broadcastStatusBtn.style.pointerEvents = "all";
  ...
  getToolspaneTitles()?.appendChild(broadcastStatusBtn);
};
var handleFullscreen = async () => {
...
var handleDropFiles = () => {
  if (isEmbed)
    return;
  eventsManager.addEventListener(document, "drop", (event) => {
    event.preventDefault();
    const files = event.dataTransfer?.files;
    if (!files?.length)
      return;
    importFromFiles(files, populateConfig, eventsManager).then(loadConfig).catch((message) => {
      notifications.error(message);
    });
  });
  eventsManager.addEventListener(document, "dragover", (event) => {
    event.preventDefault();
  });
};
...
var loadToolsPane = async () => {
  if (isLite)
    return;
  const updateConfigTools = debounce((tools) => {
    setConfig({
      ...getConfig(),
      tools
    });
...
var initApp = async (config, baseUrl2) => {
  window.deps = {
    showMode,
  ...
  await initializePlayground({ config, baseUrl: baseUrl2 }, async () => {
    basicHandlers();
    await loadToolsPane();
    await extraHandlers();
  });
